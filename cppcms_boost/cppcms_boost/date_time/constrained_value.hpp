...
#include <cppcms_boost/type_traits/is_base_of.hpp>
...
namespace CV {
  ...
  public:
    ...
    static value_type max CPPCMS_BOOST_PREVENT_MACRO_SUBSTITUTION () {return (value_policies::max)();}
    //! Return the min allowed value (traits method)
    static value_type min CPPCMS_BOOST_PREVENT_MACRO_SUBSTITUTION () {return (value_policies::min)();}
  ...
  public:
    ...
    static rep_type min CPPCMS_BOOST_PREVENT_MACRO_SUBSTITUTION () { return min_value; }
    static rep_type max CPPCMS_BOOST_PREVENT_MACRO_SUBSTITUTION () { return max_value; }
    static void on_error(rep_type, rep_type, violation_enum)
    {
      cppcms_boost::throw_exception(actual_exception_type());
    }
  };
