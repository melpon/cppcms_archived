...
#include "cppcms_boost/date_time/gregorian/gregorian_types.hpp"
#include "cppcms_boost/date_time/date_formatting_locales.hpp" // sets BOOST_DATE_TIME_NO_LOCALE
#include "cppcms_boost/date_time/gregorian/parsers.hpp"

//This file is basically commented out if locales are not supported
#ifndef CPPCMS_BOOST_DATE_TIME_NO_LOCALE
...
namespace gregorian {
  ...
  {
    typedef cppcms_boost::gregorian::greg_month month_type;
    typedef cppcms_boost::date_time::special_values special_value_enum;
    typedef cppcms_boost::gregorian::months_of_year month_enum;
    typedef cppcms_boost::date_time::weekdays weekday_enum;
  };

#if defined(USE_DATE_TIME_PRE_1_33_FACET_IO)
  //! Create the base facet type for gregorian::date
  typedef cppcms_boost::date_time::date_names_put<greg_facet_config> greg_base_facet;
  ...
  {
    typedef cppcms_boost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef cppcms_boost::date_time::ostream_date_formatter<date, facet_def, charT> greg_ostream_formatter;
  ...
  {
    typedef cppcms_boost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef cppcms_boost::date_time::ostream_month_formatter<facet_def, charT> greg_month_formatter;
  ...
  {
    typedef cppcms_boost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef cppcms_boost::date_time::ostream_weekday_formatter<greg_weekday, facet_def, charT> greg_weekday_formatter;
    std::locale locale = os.getloc();
    if (std::has_facet<facet_def>(locale)) {
      const facet_def& f = std::use_facet<facet_def>(locale);
...
#if !defined(CPPCMS_BOOST_NO_STD_ITERATOR_TRAITS)
  ...
  std::basic_istream<charT>& operator>>(std::basic_istream<charT>& is, date& d)
  {
    ...
    typedef cppcms_boost::date_time::all_date_names_put<greg_facet_config, charT> facet_def;
  ...
  CPPCMS_BOOST_DATE_TIME_DECL std::locale generate_locale(std::locale& loc, char type);
  ...
  CPPCMS_BOOST_DATE_TIME_DECL cppcms_boost::date_time::all_date_names_put<greg_facet_config, char>* create_facet_def(char type);

#ifndef CPPCMS_BOOST_NO_STD_WSTRING
  //! generates a locale with the set of gregorian name-strings of type wchar_t*
  CPPCMS_BOOST_DATE_TIME_DECL std::locale generate_locale(std::locale& loc, wchar_t type);
  //! Returns a pointer to a facet with a default set of names (English)
  /* Necessary in the event an exception is thrown from op>> for 
   * weekday or month. See comments in those functions for more info */
  CPPCMS_BOOST_DATE_TIME_DECL cppcms_boost::date_time::all_date_names_put<greg_facet_config, wchar_t>* create_facet_def(wchar_t type);
