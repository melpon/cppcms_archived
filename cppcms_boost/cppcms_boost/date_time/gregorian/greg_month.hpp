...
#include "cppcms_boost/date_time/constrained_value.hpp"
...
namespace gregorian {
  ...
  class CPPCMS_BOOST_DATE_TIME_DECL greg_month : public greg_month_rep {
  public:
    typedef date_time::months_of_year month_enum;
    typedef std::map<std::string, unsigned short> month_map_type;
    typedef cppcms_boost::shared_ptr<month_map_type> month_map_ptr_type;
