...
#include <cppcms_boost/date_time/date_duration.hpp>
#include <cppcms_boost/date_time/int_adapter.hpp>
#include <cppcms_boost/date_time/special_defs.hpp>

namespace cppcms_boost {
namespace gregorian {

  //!An internal date representation that includes infinities, not a date
  typedef cppcms_boost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public cppcms_boost::date_time::date_duration< date_duration_rep >
  {
    typedef cppcms_boost::date_time::date_duration< date_duration_rep > base_type;
...
#include <cppcms_boost/date_time/date_duration_types.hpp>
#endif
