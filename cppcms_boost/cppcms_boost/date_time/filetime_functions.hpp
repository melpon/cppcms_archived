...
#if defined(CPPCMS_BOOST_HAS_FTIME) // skip this file if no FILETIME
...
#include <cppcms_boost/date_time/time.hpp>
#include <cppcms_boost/date_time/date_defs.hpp>
...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            cppcms_boost::uint32_t dwLowDateTime;
            cppcms_boost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            cppcms_boost::uint16_t wYear;
            cppcms_boost::uint16_t wMonth;
            cppcms_boost::uint16_t wDayOfWeek;
            cppcms_boost::uint16_t wDay;
            cppcms_boost::uint16_t wHour;
            cppcms_boost::uint16_t wMinute;
            cppcms_boost::uint16_t wSecond;
            cppcms_boost::uint16_t wMilliseconds;
        };
...
#elif defined(CPPCMS_BOOST_NO_GETSYSTEMTIMEASFILETIME)
        system_time st;
        GetSystemTime(&st);
    ...
    inline cppcms_boost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
...
#if !defined(CPPCMS_BOOST_DATE_TIME_POSIX_TIME_STD_CONFIG)
