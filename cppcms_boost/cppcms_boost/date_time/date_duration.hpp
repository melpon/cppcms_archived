...
#include <cppcms_boost/operators.hpp>
...
namespace date_time {
  ...
  class date_duration : private
              cppcms_boost::less_than_comparable1< date_duration< duration_rep_traits >
            , cppcms_boost::equality_comparable1< date_duration< duration_rep_traits >
            , cppcms_boost::addable1< date_duration< duration_rep_traits >
            , cppcms_boost::subtractable1< date_duration< duration_rep_traits >
            , cppcms_boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  { 
  public:
  ...
  {
    typedef long int_type;
    typedef cppcms_boost::date_time::int_adapter<long> impl_type;
