...
#include <cppcms_boost/date_time/time_duration.hpp>
#include <cppcms_boost/date_time/time_resolution_traits.hpp>
#include <cppcms_boost/date_time/gregorian/gregorian_types.hpp>
#include <cppcms_boost/date_time/wrapping_int.hpp>
#include <cppcms_boost/date_time/compiler_config.hpp>
...
#ifdef CPPCMS_BOOST_DATE_TIME_POSIX_TIME_STD_CONFIG
  // set up conditional test compilations
#define CPPCMS_BOOST_DATE_TIME_HAS_MILLISECONDS
#define CPPCMS_BOOST_DATE_TIME_HAS_MICROSECONDS
#define CPPCMS_BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<cppcms_boost::date_time::time_resolution_traits_adapted64_impl, cppcms_boost::date_time::nano,
    1000000000, 9 > time_res_traits;
#else
  // set up conditional test compilations
#define CPPCMS_BOOST_DATE_TIME_HAS_MILLISECONDS
#define CPPCMS_BOOST_DATE_TIME_HAS_MICROSECONDS
#undef  CPPCMS_BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    cppcms_boost::date_time::time_resolution_traits_adapted64_impl, cppcms_boost::date_time::micro,
...
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(cppcms_boost::date_time::special_values sv) :
...
#if (defined(CPPCMS_BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    CPPCMS_BOOST_STATIC_CONSTANT(cppcms_boost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef cppcms_boost::int64_t time_rep_type;
...
#if (defined(CPPCMS_BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    CPPCMS_BOOST_STATIC_CONSTANT(cppcms_boost::int64_t, tick_per_second = 1000000);
#endif
  };
