...
#include <cppcms_boost/date_time/c_time.hpp>
#include <cppcms_boost/date_time/time_clock.hpp>
#include <cppcms_boost/date_time/filetime_functions.hpp>
...
namespace date_time {
  ...
  private:
    ...
    {
#ifdef CPPCMS_BOOST_HAS_GETTIMEOFDAY
      timeval tv;
      gettimeofday(&tv, 0); //gettimeofday does not support TZ adjust on Linux.
      std::time_t t = tv.tv_sec;
      cppcms_boost::uint32_t sub_sec = tv.tv_usec;
#elif defined(CPPCMS_BOOST_HAS_FTIME)
      winapi::file_time ft;
      ...
      cppcms_boost::uint32_t sub_sec = static_cast<cppcms_boost::uint32_t>(micros % 1000000UL);
#else
#error Internal Boost.DateTime error: CPPCMS_BOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK is defined, however neither gettimeofday nor FILETIME support is detected.
#endif
