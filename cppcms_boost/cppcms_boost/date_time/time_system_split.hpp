...
#if (defined(CPPCMS_BOOST_DATE_TIME_NO_MEMBER_INIT))  
  template<typename config, cppcms_boost::int32_t ticks_per_second>
#else
...
#else
   private:
     CPPCMS_BOOST_STATIC_CONSTANT(int_type, ticks_per_day = INT64_C(86400) * config::tick_per_second);
   public:
