...
#include "cppcms_boost/limits.hpp" //work around compilers without limits
#include "cppcms_boost/date_time/special_defs.hpp"
#include "cppcms_boost/date_time/locale_config.hpp"
...
public:
  ...
  static  int_adapter max CPPCMS_BOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
    return (::std::numeric_limits<int_type>::max)()-2;
  }
  static  int_adapter min CPPCMS_BOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
