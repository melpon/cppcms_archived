...
#ifndef CPPCMS_BOOST_TOKEN_FUNCTIONS_JRB120303_HPP_
#define CPPCMS_BOOST_TOKEN_FUNCTIONS_JRB120303_HPP_
...
// MSVC does not like the following typename
  ...
  struct assign_or_plus_equal {
    ...
    CPPCMS_BOOST_WORKAROUND(__SGI_STL_PORT, < 0x500) &&\
    defined(_STLP_DEBUG) &&\
  ...
  public:
    ...
    bool operator()(InputIterator& next, InputIterator end, Token& tok)
    {
      ...
      CPPCMS_BOOST_ASSERT(!offsets_.empty());
