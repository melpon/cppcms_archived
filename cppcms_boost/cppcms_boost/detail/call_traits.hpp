...
#ifndef CPPCMS_BOOST_DETAIL_CALL_TRAITS_HPP
#define CPPCMS_BOOST_DETAIL_CALL_TRAITS_HPP
...
public:
   ...
   typedef typename cppcms_boost::detail::ct_imp<
      T,
...
#if CPPCMS_BOOST_WORKAROUND( __BORLANDC__,  < 0x5A0 )
