...
#   include <cppcms_boost/detail/is_function_ref_tester.hpp>
#  endif 
...
#   if defined(CPPCMS_BOOST_MSVC) && _MSC_FULL_VER <= 13102140 // vc7.01 alpha workaround
template<class T>
...
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_reference_to_member_function_pointer,(T))
};
...
struct is_reference_to_class
    : mpl::and_<
      ...
      >
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_reference_to_class,(T))
};
...
struct is_pointer_to_class
    : mpl::and_<
      ...
      >
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_pointer_to_class,(T))
};

#  else

using namespace cppcms_boost::detail::is_function_ref_tester_;
...
struct is_reference_to_function_aux
{
    ...
    CPPCMS_BOOST_STATIC_CONSTANT(
        bool, value = sizeof(detail::is_function_ref_tester(t,0)) == sizeof(::cppcms_boost::type_traits::yes_type));
...
struct is_pointer_to_function_aux
{
    ...
    CPPCMS_BOOST_STATIC_CONSTANT(
        bool, value
        = sizeof(::cppcms_boost::type_traits::is_function_ptr_tester(t)) == sizeof(::cppcms_boost::type_traits::yes_type));
    typedef mpl::bool_<value> type;
};
...
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_pointer_to_function,(T))
};
...
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_reference_to_non_const,(T))
};
...
{   
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_reference_to_pointer,(T))
};
...
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_reference_to_function_pointer,(T))
};
