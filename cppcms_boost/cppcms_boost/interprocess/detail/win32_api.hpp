...
#ifndef CPPCMS_BOOST_INTERPROCESS_WIN32_SYNC_PRIMITIVES_HPP
#define CPPCMS_BOOST_INTERPROCESS_WIN32_SYNC_PRIMITIVES_HPP
...
{  return CPPCMS_BOOST_INTERLOCKED_INCREMENT(addr);  }

inline long interlocked_decrement(long volatile *addr)
{  return CPPCMS_BOOST_INTERLOCKED_DECREMENT(addr);  }

inline long interlocked_compare_exchange(long volatile *addr, long val1, long val2)
{  return CPPCMS_BOOST_INTERLOCKED_COMPARE_EXCHANGE(addr, val1, val2);  }

inline long interlocked_exchange_add(long volatile* addend, long value)
{  return CPPCMS_BOOST_INTERLOCKED_EXCHANGE_ADD(const_cast<long*>(addend), value);  }

inline long interlocked_exchange(long volatile* addend, long value)
{  return CPPCMS_BOOST_INTERLOCKED_EXCHANGE(const_cast<long*>(addend), value);  }
