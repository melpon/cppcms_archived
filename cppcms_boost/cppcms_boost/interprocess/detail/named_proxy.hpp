...
#ifndef CPPCMS_BOOST_INTERPROCESS_NAMED_PROXY_HPP
#define CPPCMS_BOOST_INTERPROCESS_NAMED_PROXY_HPP
...
#include <new>
#include <iterator>
#include <cppcms_boost/interprocess/detail/in_place_interface.hpp>
#include <cppcms_boost/interprocess/detail/mpl.hpp>

#ifndef CPPCMS_BOOST_INTERPROCESS_PERFECT_FORWARDING
#include <cppcms_boost/interprocess/detail/preprocessor.hpp> 
#else
#include <cppcms_boost/interprocess/detail/move.hpp>
#include <cppcms_boost/interprocess/detail/variadic_templates_tools.hpp>
...
struct CtorNArg : public placement_destroy<T>
{
   ...
   {  new((void*)mem)T(*cppcms_boost::interprocess::forward<Args>(get<IdxPack>(args_))...); }
...
class named_proxy
{
   ...
   {  
      CtorNArg<T, is_iterator, Args...> &&ctor_obj = CtorNArg<T, is_iterator, Args...>(cppcms_boost::interprocess::forward<Args>(args)...);
...
#define CPPCMS_BOOST_PP_LOCAL_MACRO(n)                                            \
   template<class T, bool is_iterator, CPPCMS_BOOST_PP_ENUM_PARAMS(n, class P) >  \
   struct CPPCMS_BOOST_PP_CAT(CPPCMS_BOOST_PP_CAT(Ctor, n), Arg)                         \
      :  public placement_destroy<T>                                       \
   {                                                                       \
      typedef detail::bool_<is_iterator> IsIterator;                       \
      typedef CPPCMS_BOOST_PP_CAT(CPPCMS_BOOST_PP_CAT(Ctor, n), Arg) self_t;             \
                                                                           \
      void do_increment(detail::true_)                                     \
         { CPPCMS_BOOST_PP_ENUM(n, CPPCMS_BOOST_INTERPROCESS_AUX_PARAM_INC, _); }        \
                                                                           \
      void do_increment(detail::false_){}                                  \
                                                                           \
      self_t& operator++()                                                 \
      ...
      self_t  operator++(int) {  return ++*this;   *this;  }               \
                                                                           \
      CPPCMS_BOOST_PP_CAT(CPPCMS_BOOST_PP_CAT(Ctor, n), Arg)                             \
         ( CPPCMS_BOOST_PP_ENUM(n, CPPCMS_BOOST_INTERPROCESS_PP_PARAM_LIST, _) )        \
         : CPPCMS_BOOST_PP_ENUM(n, CPPCMS_BOOST_INTERPROCESS_AUX_PARAM_INIT, _) {}       \
                                                                           \
      virtual void construct_n(void *mem                                   \
                        , std::size_t num                                  \
                        , std::size_t &constructed)                        \
      ...
      {                                                                    \
         new((void*)mem) T                                                 \
         (CPPCMS_BOOST_PP_ENUM(n, CPPCMS_BOOST_INTERPROCESS_PP_MEMBER_IT_FORWARD, _));   \
      }                                                                    \
                                                                           \
      void construct(void *mem, detail::false_)                            \
      {                                                                    \
         new((void*)mem) T                                                 \
            (CPPCMS_BOOST_PP_ENUM(n, CPPCMS_BOOST_INTERPROCESS_PP_MEMBER_FORWARD, _));   \
      }                                                                    \
                                                                           \
      CPPCMS_BOOST_PP_REPEAT(n, CPPCMS_BOOST_INTERPROCESS_AUX_PARAM_DEFINE, _)           \
   };                                                                      \
//!
#define CPPCMS_BOOST_PP_LOCAL_LIMITS (1, CPPCMS_BOOST_INTERPROCESS_MAX_CONSTRUCTOR_PARAMETERS)
#include CPPCMS_BOOST_PP_LOCAL_ITERATE()
...
class named_proxy
{
   ...
   #define CPPCMS_BOOST_PP_LOCAL_MACRO(n)                                               \
      template<CPPCMS_BOOST_PP_ENUM_PARAMS(n, class P)>                                 \
      T *operator()(CPPCMS_BOOST_PP_ENUM (n, CPPCMS_BOOST_INTERPROCESS_PP_PARAM_LIST, _)) const\
      {                                                                          \
         typedef CPPCMS_BOOST_PP_CAT(CPPCMS_BOOST_PP_CAT(Ctor, n), Arg)                        \
            <T, is_iterator, CPPCMS_BOOST_PP_ENUM_PARAMS(n, P)>                         \
            ctor_obj_t;                                                          \
         ctor_obj_t ctor_obj                                                     \
            (CPPCMS_BOOST_PP_ENUM(n, CPPCMS_BOOST_INTERPROCESS_PP_PARAM_FORWARD, _));          \
