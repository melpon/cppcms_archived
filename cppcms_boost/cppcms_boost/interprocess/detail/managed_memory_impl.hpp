...
#ifndef CPPCMS_BOOST_INTERPROCESS_DETAIL_MANAGED_MEMORY_IMPL_HPP
#define CPPCMS_BOOST_INTERPROCESS_DETAIL_MANAGED_MEMORY_IMPL_HPP
...
#include <cppcms_boost/interprocess/mem_algo/rbtree_best_fit.hpp>
#include <cppcms_boost/interprocess/sync/mutex_family.hpp>
#include <cppcms_boost/interprocess/detail/utilities.hpp>
#include <cppcms_boost/interprocess/detail/os_file_functions.hpp>
...
#include <cppcms_boost/interprocess/segment_manager.hpp>
...
class basic_managed_memory_impl
{
   ...
   {  return mp_header->deallocate_many(cppcms_boost::interprocess::move(chain)); }
