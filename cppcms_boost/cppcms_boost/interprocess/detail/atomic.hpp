...
#ifndef CPPCMS_BOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
#define CPPCMS_BOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
...
inline cppcms_boost::uint32_t atomic_inc32(volatile cppcms_boost::uint32_t *mem);

//! Atomically read an boost::uint32_t from memory
inline cppcms_boost::uint32_t atomic_read32(volatile cppcms_boost::uint32_t *mem);

//! Atomically set an boost::uint32_t in memory
//! "mem": pointer to the object
//! "param": val value that the object will assume
inline void atomic_write32(volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t val);
...
inline cppcms_boost::uint32_t atomic_cas32
   (volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t with, cppcms_boost::uint32_t cmp);

}  //namespace detail{
}  //namespace interprocess{
}  //namespace boost{

#if (defined CPPCMS_BOOST_INTERPROCESS_WINDOWS)

#include <cppcms_boost/interprocess/detail/win32_api.hpp>
...
//! Returns the old value pointed to by mem
inline cppcms_boost::uint32_t atomic_dec32(volatile cppcms_boost::uint32_t *mem)
...
inline cppcms_boost::uint32_t atomic_cas32
   (volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t with, cppcms_boost::uint32_t cmp)
{
   cppcms_boost::uint32_t prev = cmp;
   asm volatile( "lock\n\t"
                 "cmpxchg %3,%1"
               : "=a" (prev), "=m" (*(mem))
               : "0" (prev), "r" (with)
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline cppcms_boost::uint32_t atomic_add32
   (volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t val)
{
   // int r = *pw;
   // *mem += val;
   // return r;
...
//! Returns the old value pointed to by mem
inline cppcms_boost::uint32_t atomic_dec32(volatile cppcms_boost::uint32_t *mem)
{  return atomic_add32(mem, (cppcms_boost::uint32_t)-1);  }
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline cppcms_boost::uint32_t atomic_add32(volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t val)
{
   cppcms_boost::uint32_t prev, temp;
...
//! Returns the old value pointed to by mem
inline cppcms_boost::uint32_t atomic_dec32(volatile cppcms_boost::uint32_t *mem)
{  return atomic_add32(mem, cppcms_boost::uint32_t(-1u));  }
...
inline cppcms_boost::uint32_t atomic_add32
   (volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t val)
{  return __sync_fetch_and_add(const_cast<cppcms_boost::uint32_t *>(mem), val);   }
...
inline cppcms_boost::uint32_t atomic_cas32
   (volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t with, cppcms_boost::uint32_t cmp)
{  return __sync_val_compare_and_swap(const_cast<cppcms_boost::uint32_t *>(mem), cmp, with);   }
...
//! Returns the old value pointed to by mem
inline cppcms_boost::uint32_t atomic_dec32(volatile cppcms_boost::uint32_t *mem)
{  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem), (cppcms_boost::uint32_t)-1) + 1; }
...
inline cppcms_boost::uint32_t atomic_dec32(volatile cppcms_boost::uint32_t *mem)
{  cppcms_boost::uint32_t old_val = __ATOMIC_DECREMENT_LONG(mem); __MB(); return old_val; }
...
inline cppcms_boost::uint32_t atomic_read32(volatile cppcms_boost::uint32_t *mem)
{  cppcms_boost::uint32_t old_val = *mem; __MB(); return old_val;  }
...
inline cppcms_boost::uint32_t lwarxu(volatile cppcms_boost::uint32_t *mem)  
{  
   return static_cast<cppcms_boost::uint32_t>(__lwarx(reinterpret_cast<volatile int*>(mem)));  
}  
...
//!unsuccessful  
inline bool stwcxu(volatile cppcms_boost::uint32_t* mem, cppcms_boost::uint32_t val)  
{  
...
inline cppcms_boost::uint32_t atomic_add32  
   (volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t val)  
{  
   cppcms_boost::uint32_t oldValue;  
   do  
   {  
      oldValue = lwarxu(mem);  
...
{  
   cppcms_boost::uint32_t oldValue;  
   cppcms_boost::uint32_t valueToStore;  
   do  
   {  
      oldValue = lwarxu(mem);  
...
inline bool atomic_add_unless32
   (volatile cppcms_boost::uint32_t *mem, cppcms_boost::uint32_t value, volatile cppcms_boost::uint32_t unless_this)
{
   cppcms_boost::uint32_t old, c(atomic_read32(mem));
