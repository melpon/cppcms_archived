...
#ifndef CPPCMS_BOOST_INTERPROCESS_DETAIL_OS_THREAD_FUNCTIONS_HPP
#define CPPCMS_BOOST_INTERPROCESS_DETAIL_OS_THREAD_FUNCTIONS_HPP
...
#else
#  ifdef CPPCMS_BOOST_HAS_UNISTD_H
#     include <pthread.h>
#     include <unistd.h>
#     include <sched.h>
#  else
