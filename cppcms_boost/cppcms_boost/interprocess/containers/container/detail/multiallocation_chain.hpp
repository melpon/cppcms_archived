...
#ifndef CPPCMS_BOOST_CONTAINERS_DETAIL_MULTIALLOCATION_CHAIN_HPP
#define CPPCMS_BOOST_CONTAINERS_DETAIL_MULTIALLOCATION_CHAIN_HPP

#include <cppcms_boost/interprocess/containers/container/detail/config_begin.hpp>
#include <cppcms_boost/interprocess/containers/container/container_fwd.hpp>
#include <cppcms_boost/interprocess/containers/container/detail/utilities.hpp>
#include <cppcms_boost/interprocess/containers/container/detail/type_traits.hpp>
#include <cppcms_boost/interprocess/containers/container/detail/transform_iterator.hpp>
#include <cppcms_boost/intrusive/slist.hpp>
...
class basic_multiallocation_chain
{
   ...
   CPPCMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(basic_multiallocation_chain)
   ...
   basic_multiallocation_chain(CPPCMS_BOOST_INTERPROCESS_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_()
   {  slist_impl_.swap(other.slist_impl_); }

   basic_multiallocation_chain& operator=(CPPCMS_BOOST_INTERPROCESS_RV_REF(basic_multiallocation_chain) other)
   {
      basic_multiallocation_chain tmp(cppcms_boost::interprocess::move(other));
      this->swap(tmp);
      return *this;
   }
...
{
   private:
   CPPCMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(transform_multiallocation_chain)
   ...
   transform_multiallocation_chain(CPPCMS_BOOST_INTERPROCESS_RV_REF(transform_multiallocation_chain) other)
      : holder_()
   {  this->swap(other); }

   transform_multiallocation_chain(CPPCMS_BOOST_INTERPROCESS_RV_REF(MultiallocationChain) other)
      : holder_(cppcms_boost::interprocess::move(other))
   {}

   transform_multiallocation_chain& operator=(CPPCMS_BOOST_INTERPROCESS_RV_REF(transform_multiallocation_chain) other)
   {
      transform_multiallocation_chain tmp(cppcms_boost::interprocess::move(other));
      this->swap(tmp);
      return *this;
   }
   ...
   {
      return MultiallocationChain(cppcms_boost::interprocess::move(holder_));
   }
};
