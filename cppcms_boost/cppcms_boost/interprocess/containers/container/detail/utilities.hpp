...
#ifndef CPPCMS_BOOST_CONTAINERS_DETAIL_UTILITIES_HPP
#define CPPCMS_BOOST_CONTAINERS_DETAIL_UTILITIES_HPP
...
#include <cppcms_boost/interprocess/containers/container/detail/mpl.hpp>
...
struct move_const_ref_type
   : if_c
   < ::cppcms_boost::is_fundamental<T>::value || ::cppcms_boost::is_pointer<T>::value
   ,const T &
   ,CPPCMS_BOOST_INTERPROCESS_CATCH_CONST_RLVALUE(T)
   >
{};
