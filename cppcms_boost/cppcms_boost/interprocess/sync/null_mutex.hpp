...
#ifndef CPPCMS_BOOST_INTERPROCESS_NULL_MUTEX_HPP
#define CPPCMS_BOOST_INTERPROCESS_NULL_MUTEX_HPP
...
class null_mutex
{
   ...
   //!Equivalent to "return true;"
   bool timed_lock(const cppcms_boost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_sharable(const cppcms_boost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_upgradable(const cppcms_boost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_unlock_upgradable_and_lock(const cppcms_boost::posix_time::ptime &)
   {  return true;   }
