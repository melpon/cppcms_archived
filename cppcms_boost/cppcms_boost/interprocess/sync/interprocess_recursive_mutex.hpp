...
#ifndef CPPCMS_BOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
#define CPPCMS_BOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
...
#if !defined(CPPCMS_BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && \
   (defined(CPPCMS_BOOST_INTERPROCESS_POSIX_PROCESS_SHARED) && defined (CPPCMS_BOOST_INTERPROCESS_POSIX_RECURSIVE_MUTEXES))
   #include <pthread.h>
   #include <errno.h>   
...
#  include <cppcms_boost/interprocess/sync/emulation/interprocess_recursive_mutex.hpp>
#endif

#ifdef CPPCMS_BOOST_INTERPROCESS_USE_POSIX
#  undef CPPCMS_BOOST_INTERPROCESS_USE_POSIX
#  include <cppcms_boost/interprocess/sync/posix/interprocess_recursive_mutex.hpp>
#endif
