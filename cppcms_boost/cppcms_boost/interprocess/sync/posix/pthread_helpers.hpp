...
#ifndef CPPCMS_BOOST_INTERPROCESS_PTHREAD_HELPERS_HPP
#define CPPCMS_BOOST_INTERPROCESS_PTHREAD_HELPERS_HPP
...
namespace detail{
   ...
   #if defined CPPCMS_BOOST_INTERPROCESS_POSIX_PROCESS_SHARED
   ...
   struct mutexattr_wrapper 
   {
      ...
      mutexattr_wrapper(bool recursive = false)
      {
         if(pthread_mutexattr_init(&m_attr)!=0 ||
            ...
            throw cppcms_boost::interprocess::interprocess_exception();
      }
   ...
   #if defined(CPPCMS_BOOST_INTERPROCESS_POSIX_BARRIERS) && defined(CPPCMS_BOOST_INTERPROCESS_POSIX_PROCESS_SHARED)
