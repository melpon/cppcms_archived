...
#ifndef CPPCMS_BOOST_OFFSET_PTR_HPP
#define CPPCMS_BOOST_OFFSET_PTR_HPP
...
#include <cppcms_boost/interprocess/detail/cast_tags.hpp>
...
class offset_ptr
{
   ...
   void set_offset(const void *ptr)
   {
      ...
      if(!ptr){
         ...
         CPPCMS_BOOST_ASSERT(m_offset != 1);
      }
   }
...
//!for offset_ptr
template<class T>
inline void swap (cppcms_boost::interprocess::offset_ptr<T> &pt, 
                  cppcms_boost::interprocess::offset_ptr<T> &pt2)
{  
...
inline cppcms_boost::interprocess::offset_ptr<T> 
   static_pointer_cast(cppcms_boost::interprocess::offset_ptr<U> const & r)
{  
   return cppcms_boost::interprocess::offset_ptr<T>
            (r, cppcms_boost::interprocess::detail::static_cast_tag());  
}

//!Simulation of const_cast between pointers. Never throws.
template<class T, class U> 
inline cppcms_boost::interprocess::offset_ptr<T>
   const_pointer_cast(cppcms_boost::interprocess::offset_ptr<U> const & r)
{  
   return cppcms_boost::interprocess::offset_ptr<T>
            (r, cppcms_boost::interprocess::detail::const_cast_tag());  
}

//!Simulation of dynamic_cast between pointers. Never throws.
template<class T, class U> 
inline cppcms_boost::interprocess::offset_ptr<T> 
   dynamic_pointer_cast(cppcms_boost::interprocess::offset_ptr<U> const & r)
{  
   return cppcms_boost::interprocess::offset_ptr<T>
            (r, cppcms_boost::interprocess::detail::dynamic_cast_tag());  
}

//!Simulation of reinterpret_cast between pointers. Never throws.
template<class T, class U> 
inline cppcms_boost::interprocess::offset_ptr<T>
   reinterpret_pointer_cast(cppcms_boost::interprocess::offset_ptr<U> const & r)
{  
   return cppcms_boost::interprocess::offset_ptr<T>
            (r, cppcms_boost::interprocess::detail::reinterpret_cast_tag());  
}
...
template <class T>
struct has_trivial_constructor< cppcms_boost::interprocess::offset_ptr<T> > 
{
   enum { value = true };
};
...
template <class T>
struct has_trivial_destructor< cppcms_boost::interprocess::offset_ptr<T> > 
{
   enum { value = true };
};
...
//!Never throws.
template<class T>
inline T * get_pointer(cppcms_boost::interprocess::offset_ptr<T> const & p)
{  return p.get();   }
//#if !defined(_MSC_VER) || (_MSC_VER >= 1400)
}  //namespace interprocess
//#endif
...
struct max_pointer_plus_bits<cppcms_boost::interprocess::offset_ptr<void>, Alignment>
{
   //The offset ptr can embed one bit less than the alignment since it
   //uses offset == 1 to store the null pointer.
   static const std::size_t value = ::cppcms_boost::interprocess::detail::ls_zeros<Alignment>::value - 1;
};
...
struct pointer_plus_bits<cppcms_boost::interprocess::offset_ptr<T>, NumBits>
{
   typedef cppcms_boost::interprocess::offset_ptr<T>         pointer;
