...
#ifndef CPPCMS_BOOST_INTERPROCESS_ALLOCATOR_HPP
#define CPPCMS_BOOST_INTERPROCESS_ALLOCATOR_HPP
...
#include <cppcms_boost/interprocess/allocators/detail/allocator_common.hpp>
#include <cppcms_boost/interprocess/detail/utilities.hpp>
#include <cppcms_boost/interprocess/containers/version_type.hpp>
...
class allocator 
{
   ...
   typedef cppcms_boost::interprocess::version_type<allocator, 2>   version;
   ...
   {  return this->deallocate_many(cppcms_boost::interprocess::move(chain)); }
...
template<class T, class SegmentManager>
struct has_trivial_destructor
   <cppcms_boost::interprocess::allocator <T, SegmentManager> >
{
   enum { value = true };
};
/// @endcond
