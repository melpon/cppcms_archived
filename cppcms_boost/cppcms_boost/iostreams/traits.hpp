...
#ifndef CPPCMS_BOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
...
#include <cppcms_boost/config.hpp>  // partial spec, deduced typename.
...
#include <cppcms_boost/iostreams/detail/select_by_size.hpp>      
#include <cppcms_boost/iostreams/detail/wrap_unwrap.hpp>       
#include <cppcms_boost/iostreams/traits_fwd.hpp> 
...
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::basic_istream, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::basic_ostream, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::basic_iostream, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::basic_streambuf, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ifstream, std::basic_ifstream, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ofstream, std::basic_ofstream, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_fstream, std::basic_fstream, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_filebuf, std::basic_filebuf, 2)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istringstream, std::basic_istringstream, 3)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostringstream, std::basic_ostringstream, 3)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringstream, std::basic_stringstream, 3)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringbuf, std::basic_stringbuf, 3)

#else // #ifndef BOOST_IOSTREAMS_NO_STREAM_TEMPLATES //-----------------------//

CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::istream, 0)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::ostream, 0)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::iostream, 0)
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::streambuf, 0)
...
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_cppcms_boost_stream,
                                cppcms_boost::iostreams::stream,
                                3 )
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_cppcms_boost_stream_buffer,
                                cppcms_boost::iostreams::stream_buffer,
                                4 )
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_stream_impl,
                                cppcms_boost::iostreams::filtering_stream,
                                5 )
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstream_impl,
                                cppcms_boost::iostreams::wfiltering_stream,
                                5 )
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_streambuf_impl,
                                cppcms_boost::iostreams::filtering_streambuf,
                                5 )
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstreambuf_impl,
                                cppcms_boost::iostreams::filtering_wstreambuf,
                                5 )
CPPCMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_linked, linked_streambuf, 2)
...
template<typename T>
struct is_cppcms_boost
    : mpl::or_<
          is_cppcms_boost_stream<T>, 
          is_cppcms_boost_stream_buffer<T>, 
...
struct char_type_of {
    ...
    typedef typename 
            mpl::eval_if<
                ...
                get_value_type<T>,
                detail::member_char_type<
                    CPPCMS_BOOST_DEDUCED_TYPENAME detail::unwrapped_type<T>::type
                >
            >::type type;
};
...
struct category_of {
    ...
    typedef typename  
            mpl::eval_if<
                mpl::and_<
                    is_std_io<U>,
                    mpl::not_< detail::is_cppcms_boost<U> >
                >,
...
#define CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(tag_, id_) \
    case_<id_> io_mode_impl_helper(tag_); \
    template<> struct io_mode_impl<id_> { typedef tag_ type; }; \
    /**/
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(input, 1)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(output, 2)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(bidirectional, 3)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(input_seekable, 4)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(output_seekable, 5)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(seekable, 6)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(dual_seekable, 7)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(bidirectional_seekable, 8)
CPPCMS_BOOST_IOSTREAMS_MODE_HELPER(dual_use, 9)
#undef CPPCMS_BOOST_IOSTREAMS_MODE_HELPER

template<typename T>
struct io_mode_id {
    typedef typename category_of<T>::type category;
    CPPCMS_BOOST_SELECT_BY_SIZE(int, value, detail::io_mode_impl_helper(category()));
};
...
struct has_trait_impl {
    typedef typename category_of<T>::type category;
    CPPCMS_BOOST_STATIC_CONSTANT(bool, value = (is_convertible<category, Tag>::value));
};
...
#define CPPCMS_BOOST_IOSTREAMS_STREAMBUF_TYPEDEFS(Tr) \
