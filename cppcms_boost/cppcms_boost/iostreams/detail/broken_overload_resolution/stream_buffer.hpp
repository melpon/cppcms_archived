...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_BROKEN_OVERLOAD_RESOLUTION_STREAM_BUFFER_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_BROKEN_OVERLOAD_RESOLUTION_STREAM_BUFFER_HPP_INCLUDED
...
private:
    ...
    {
        if (this->is_open()) 
            throw CPPCMS_BOOST_IOSTREAMS_FAILURE("already open");
    }
};
