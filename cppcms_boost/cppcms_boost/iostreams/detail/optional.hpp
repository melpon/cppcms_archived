...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_OPTIONAL_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_OPTIONAL_HPP_INCLUDED
...
public:
    ...
    void reset() 
    {
        if (initialized_) { 
            ...
            CPPCMS_BOOST_WORKAROUND(__IBMCPP__, CPPCMS_BOOST_TESTED_AT(600)) \
            /**/
