...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_CHAINBUF_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_CHAINBUF_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/chain.hpp>
...
#include <cppcms_boost/iostreams/detail/translate_int_type.hpp>
...
class chainbuf
    : public CPPCMS_BOOST_IOSTREAMS_BASIC_STREAMBUF(
...
public:
    ...
    CPPCMS_BOOST_IOSTREAMS_STREAMBUF_TYPEDEFS(typename Chain::traits_type)
protected:
...
private:
    ...
    typedef CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS(char_type)           std_traits;
