...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/detail/ios.hpp>          // openmode.
...
#define CPPCMS_BOOST_IOSTREAMS_USING_PROTECTED_STREAMBUF_MEMBERS(base) \
...
template<typename Ch, typename Tr = CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS(Ch) >
class linked_streambuf : public CPPCMS_BOOST_IOSTREAMS_BASIC_STREAMBUF(Ch, Tr) {
protected:
...
protected:
...
#else
    public:
        typedef CPPCMS_BOOST_IOSTREAMS_BASIC_STREAMBUF(Ch, Tr) base;
        CPPCMS_BOOST_IOSTREAMS_USING_PROTECTED_STREAMBUF_MEMBERS(base)
#endif
    void close(CPPCMS_BOOST_IOS::openmode which)
    {
        if ( which == CPPCMS_BOOST_IOS::in && 
    ...
    virtual void close_impl(CPPCMS_BOOST_IOS::openmode) = 0;
