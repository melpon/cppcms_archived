...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED
...
public:
    ...
    std::streampos seek(Device& dev, stream_offset off, CPPCMS_BOOST_IOS::seekdir way)
...
{ return cppcms_boost::iostreams::seek(t_, off, way, which); }
    ...
    template<typename Mode, typename T>
    void mode_adapter<Mode, T>::close(CPPCMS_BOOST_IOS::openmode which) 
