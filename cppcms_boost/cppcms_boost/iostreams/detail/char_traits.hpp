...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
...
# define CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS(ch) std::char_traits< ch >
#else
# define CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS(ch) cppcms_boost::iostreams::detail::char_traits
