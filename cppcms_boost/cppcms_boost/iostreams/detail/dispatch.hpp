...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_DISPATCH_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_DISPATCH_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/traits.hpp>         // category_of. 
