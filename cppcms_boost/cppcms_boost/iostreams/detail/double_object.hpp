...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
...
#else
    typedef cppcms_boost::call_traits<T>                  traits_type;
#endif
