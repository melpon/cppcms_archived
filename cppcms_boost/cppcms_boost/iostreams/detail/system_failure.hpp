...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
...
#if defined(CPPCMS_BOOST_NO_STDC_NAMESPACE) && !defined(__LIBCOMO__)
...
inline CPPCMS_BOOST_IOSTREAMS_FAILURE system_failure(const char* msg)
{
    std::string result;
#ifdef CPPCMS_BOOST_IOSTREAMS_WINDOWS
    DWORD err;
...
#endif
    return CPPCMS_BOOST_IOSTREAMS_FAILURE(result);
}

inline CPPCMS_BOOST_IOSTREAMS_FAILURE system_failure(const std::string& msg)
