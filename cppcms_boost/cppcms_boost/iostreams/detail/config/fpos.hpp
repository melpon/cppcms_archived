...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_CONFIG_FPOS_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_CONFIG_FPOS_HPP_INCLUDED
...
# if (defined(_YVALS) || defined(_CPPLIB_VER)) && !defined(__SGI_STL_PORT) && \
     ...
     /**/
#  define CPPCMS_BOOST_IOSTREAMS_HAS_DINKUMWARE_FPOS
# endif
