...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_CONFIG_BZIP2_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_CONFIG_BZIP2_HPP_INCLUDED

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
# pragma once
#endif              

#if defined(CPPCMS_BOOST_BZIP2_BINARY)
...
#  pragma comment(lib, CPPCMS_BOOST_STRINGIZE(CPPCMS_BOOST_BZIP2_BINARY))
# endif
#else 
...
#  define CPPCMS_BOOST_LIB_NAME cppcms_boost_bzip2
