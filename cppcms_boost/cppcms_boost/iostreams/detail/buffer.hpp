...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_BUFFERS_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_BUFFERS_HPP_INCLUDED
...
#include <cppcms_boost/config.hpp>                    // member templates.
...
#include <cppcms_boost/iostreams/traits.hpp>          // int_type_of.
#include <cppcms_boost/iostreams/checked_operations.hpp>
