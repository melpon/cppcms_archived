...
#ifndef CPPCMS_BOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/detail/config/bzip2.hpp>
...
CPPCMS_BOOST_IOSTREAMS_DECL extern const int ok;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int run_ok;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int flush_ok;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int finish_ok;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int stream_end;    
CPPCMS_BOOST_IOSTREAMS_DECL extern const int sequence_error;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int param_error;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int mem_error;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int data_error;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int data_error_magic;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int io_error;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int unexpected_eof;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int outbuff_full;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int config_error;

                    // Action codes

CPPCMS_BOOST_IOSTREAMS_DECL extern const int finish;
CPPCMS_BOOST_IOSTREAMS_DECL extern const int run;
...
//
class CPPCMS_BOOST_IOSTREAMS_DECL bzip2_error : public CPPCMS_BOOST_IOSTREAMS_FAILURE {
public:
...
template< typename Alloc,
          typename Base = // VC6 workaround (C2516)
              CPPCMS_BOOST_DEDUCED_TYPENAME bzip2_allocator_traits<Alloc>::type >
...
class CPPCMS_BOOST_IOSTREAMS_DECL bzip2_base  { 
public:
...
CPPCMS_BOOST_IOSTREAMS_PIPABLE(basic_bzip2_compressor, 1)
...
CPPCMS_BOOST_IOSTREAMS_PIPABLE(basic_bzip2_decompressor, 1)
