...
#ifndef CPPCMS_BOOST_IOSTREAMS_OPTIMAL_BUFFER_SIZE_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_OPTIMAL_BUFFER_SIZE_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/constants.hpp>  // constants.
