...
#ifndef CPPCMS_BOOST_IOSTREAMS_DETAIL_CHECKED_OPERATIONS_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_DETAIL_CHECKED_OPERATIONS_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/get.hpp>
#include <cppcms_boost/iostreams/put.hpp>
#include <cppcms_boost/iostreams/read.hpp>
#include <cppcms_boost/iostreams/seek.hpp>
#include <cppcms_boost/iostreams/traits.hpp>
#include <cppcms_boost/iostreams/write.hpp>
...
seek_if( T& t, stream_offset off, CPPCMS_BOOST_IOS::seekdir way, 
...
struct seek_if_impl<any_tag> {
    template<typename T>
    static std::streampos 
    seek(T&, stream_offset, CPPCMS_BOOST_IOS::seekdir, CPPCMS_BOOST_IOS::openmode)
    { throw cant_seek(); }
};
