...
#ifndef CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS_HPP_INCLUDED
...
#if (defined(__QNX__) && defined(CPPCMS_BOOST_DINKUMWARE_STDLIB))  \
    || defined(__SUNPRO_CC)
using ::std::wint_t;
#endif
...
template<>
struct char_traits<char> : CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS(char) {
