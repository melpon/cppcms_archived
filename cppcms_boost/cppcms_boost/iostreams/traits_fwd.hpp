...
#ifndef CPPCMS_BOOST_IOSTREAMS_IO_TRAITS_FWD_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_IO_TRAITS_FWD_HPP_INCLUDED
...
template<typename T>
struct is_cppcms_boost_stream;

template<typename T>
struct is_cppcms_boost_stream_buffer;
