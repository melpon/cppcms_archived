...
#ifndef CPPCMS_BOOST_IOSTREAMS_FLUSH_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_FLUSH_HPP_INCLUDED
...
struct flush_device_impl<ostream_tag> {
    ...
    { return t.rdbuf()->CPPCMS_BOOST_IOSTREAMS_PUBSYNC() == 0; }
};
...
struct flush_device_impl<streambuf_tag> {
    template<typename T>
    static bool flush(T& t)
    { return t.CPPCMS_BOOST_IOSTREAMS_PUBSYNC() == 0; }
};
