...
#ifndef CPPCMS_BOOST_IOSTREAMS_FILE_DESCRIPTOR_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_FILE_DESCRIPTOR_HPP_INCLUDED
...
#include <string>
#include <cppcms_boost/cstdint.hpp>               // intmax_t.
#include <cppcms_boost/iostreams/categories.hpp>  // tags.
...
#include <cppcms_boost/iostreams/detail/file_handle.hpp>
#include <cppcms_boost/iostreams/detail/ios.hpp>  // openmode, seekdir, int types.
...
class CPPCMS_BOOST_IOSTREAMS_DECL file_descriptor {
public:
...
private:
    ...
    void open( const detail::path& path, 
               CPPCMS_BOOST_IOS::openmode, 
               CPPCMS_BOOST_IOS::openmode = CPPCMS_BOOST_IOS::in | CPPCMS_BOOST_IOS::out );
...
public:
    ...
    explicit file_descriptor_source( const std::string& path,
                                     CPPCMS_BOOST_IOS::openmode mode = CPPCMS_BOOST_IOS::in );
    ...
    // open overload taking a std::string
    void open(const std::string& path, CPPCMS_BOOST_IOS::openmode mode = CPPCMS_BOOST_IOS::in);

    // open overload taking C-style string
    void open(const char* path, CPPCMS_BOOST_IOS::openmode mode = CPPCMS_BOOST_IOS::in);

    // open overload taking a Boost.Filesystem path
    template<typename Path>
    void open(const Path& path, CPPCMS_BOOST_IOS::openmode mode = CPPCMS_BOOST_IOS::in);
private:

    // open overload taking a detail::path
    void open(const detail::path& path, CPPCMS_BOOST_IOS::openmode);
};
...
public:
    ...
    explicit file_descriptor_sink( const std::string& path,
                                   CPPCMS_BOOST_IOS::openmode mode = CPPCMS_BOOST_IOS::out );
