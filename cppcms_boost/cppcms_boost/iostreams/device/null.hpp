...
#ifndef CPPCMS_BOOST_IOSTREAMS_NULL_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_NULL_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/detail/ios.hpp> // openmode, streamsize.
...
public:
    ...
    std::streampos seek( stream_offset, CPPCMS_BOOST_IOS::seekdir,
