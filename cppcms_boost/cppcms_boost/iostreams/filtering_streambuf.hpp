...
#ifndef CPPCMS_BOOST_IOSTREAMS_FILTERING_STREAMBUF_HPP_INCLUDED
#define CPPCMS_BOOST_IOSTREAMS_FILTERING_STREAMBUF_HPP_INCLUDED
...
#include <cppcms_boost/iostreams/detail/streambuf/chainbuf.hpp>
...
//
#define CPPCMS_BOOST_IOSTREAMS_DEFINE_FILTER_STREAMBUF(name_, chain_type_, default_char_) \
    template< typename Mode, \
              typename Ch = default_char_, \
              typename Tr = CPPCMS_BOOST_IOSTREAMS_CHAR_TRAITS(Ch), \
              typename Alloc = std::allocator<Ch>, \
              typename Access = public_ > \
    class name_ : public cppcms_boost::iostreams::detail::chainbuf< \
    ...
    public: \
        ...
        ~name_() { if (this->is_complete()) this->CPPCMS_BOOST_IOSTREAMS_PUBSYNC(); } \
    }; \
    /**/ 
CPPCMS_BOOST_IOSTREAMS_DEFINE_FILTER_STREAMBUF(filtering_streambuf, cppcms_boost::iostreams::chain, char)
CPPCMS_BOOST_IOSTREAMS_DEFINE_FILTER_STREAMBUF(filtering_wstreambuf, cppcms_boost::iostreams::chain, wchar_t)
