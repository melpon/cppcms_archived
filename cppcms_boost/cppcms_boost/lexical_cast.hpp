#ifndef CPPCMS_BOOST_LEXICAL_CAST_INCLUDED
#define CPPCMS_BOOST_LEXICAL_CAST_INCLUDED
...
#include <cppcms_boost/type_traits/make_unsigned.hpp>
#include <cppcms_boost/call_traits.hpp>
#include <cppcms_boost/static_assert.hpp>
#include <cppcms_boost/detail/lcast_precision.hpp>
...
#ifdef CPPCMS_BOOST_NO_STRINGSTREAM
#include <strstream>
#else
#include <sstream>
#endif

#if defined(CPPCMS_BOOST_NO_STRINGSTREAM) || defined(CPPCMS_BOOST_NO_STD_WSTRING)
#define CPPCMS_BOOST_LCAST_NO_WCHAR_T
#endif

#ifdef CPPCMS_BOOST_NO_TYPEID
#define CPPCMS_BOOST_LCAST_THROW_BAD_CAST(S, T) throw_exception(bad_lexical_cast())
#else
#define CPPCMS_BOOST_LCAST_THROW_BAD_CAST(Source, Target) \
...
namespace cppcms_boost
{
...
#if defined(__BORLANDC__) && CPPCMS_BOOST_WORKAROUND( __BORLANDC__, < 0x560 )
...
#ifndef CPPCMS_BOOST_LCAST_NO_WCHAR_T
    ...
    namespace detail // lcast_src_length
    {
        ...
        {
            CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, value = 0);
        ...
        {
            CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, value = 1);
            static void check_coverage() {}
        };
        ...
        {
#ifndef CPPCMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#else
            CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, value = 156);
            CPPCMS_BOOST_STATIC_ASSERT(sizeof(Source) * CHAR_BIT <= 256);
#endif
        };

#define CPPCMS_BOOST_LCAST_DEF1(CharT, T)               \
    template<> struct lcast_src_length<CharT, T> \
        : lcast_src_length_integral<T>           \
    { static void check_coverage() {} };

#ifdef CPPCMS_BOOST_LCAST_NO_WCHAR_T
#define CPPCMS_BOOST_LCAST_DEF(T) CPPCMS_BOOST_LCAST_DEF1(char, T)
#else
#define CPPCMS_BOOST_LCAST_DEF(T)          \
        CPPCMS_BOOST_LCAST_DEF1(char, T)   \
        CPPCMS_BOOST_LCAST_DEF1(wchar_t, T)
#endif

        CPPCMS_BOOST_LCAST_DEF(short)
        CPPCMS_BOOST_LCAST_DEF(unsigned short)
        CPPCMS_BOOST_LCAST_DEF(int)
        CPPCMS_BOOST_LCAST_DEF(unsigned int)
        CPPCMS_BOOST_LCAST_DEF(long)
        CPPCMS_BOOST_LCAST_DEF(unsigned long)
#if defined(CPPCMS_BOOST_HAS_LONG_LONG)
        CPPCMS_BOOST_LCAST_DEF(cppcms_boost::ulong_long_type)
        CPPCMS_BOOST_LCAST_DEF(cppcms_boost::long_long_type )
#elif defined(CPPCMS_BOOST_HAS_MS_INT64)
        CPPCMS_BOOST_LCAST_DEF(unsigned __int64)
        CPPCMS_BOOST_LCAST_DEF(         __int64)
#endif

#undef CPPCMS_BOOST_LCAST_DEF
#undef CPPCMS_BOOST_LCAST_DEF1

#ifndef CPPCMS_BOOST_LCAST_NO_COMPILE_TIME_PRECISION
    ...
    namespace detail // '0' and '-' constants
    {
        ...
        {
            CPPCMS_BOOST_STATIC_CONSTANT(char, zero  = '0');
            CPPCMS_BOOST_STATIC_CONSTANT(char, minus = '-');
        };
        ...
        {
            CPPCMS_BOOST_STATIC_CONSTANT(wchar_t, zero  = L'0');
            CPPCMS_BOOST_STATIC_CONSTANT(wchar_t, minus = L'-');
        };
#endif
    }
...
# pragma option push -w-8041
        ...
        template<class T>
        inline
        CPPCMS_BOOST_DEDUCED_TYPENAME make_unsigned<T>::type lcast_to_unsigned(T value)
        {
            typedef CPPCMS_BOOST_DEDUCED_TYPENAME make_unsigned<T>::type result_type;
...
# pragma option pop
    ...
    namespace detail // lcast_put_unsigned
    {
        ...
        {
#ifndef CPPCMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
            CPPCMS_BOOST_STATIC_ASSERT(!std::numeric_limits<T>::is_signed);
#endif

#ifndef CPPCMS_BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
            // TODO: use BOOST_NO_STD_LOCALE
            std::locale loc;
            typedef std::numpunct<CharT> numpunct;
            numpunct const& np = CPPCMS_BOOST_USE_FACET(numpunct, loc);
...
#ifndef CPPCMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
            CPPCMS_BOOST_STATIC_ASSERT(std::numeric_limits<T>::digits10 < CHAR_MAX);
#endif
    ...
    namespace detail // stream wrapper for handling lexical conversions
    {
        ...
        public:
            ...
            ~lexical_stream()
            {
                #if defined(CPPCMS_BOOST_NO_STRINGSTREAM)
                stream.freeze(false);
                #endif
            }
            ...
            bool operator>>(InputStreamable &output)
            {
                return !is_pointer<InputStreamable>::value &&
                       stream >> output &&
                       stream.get() ==
#if defined(__GNUC__) && (__GNUC__<3) && defined(CPPCMS_BOOST_NO_STD_WSTRING)
...
// configurations, which do provide std::char_traits<>::eof().
        ...
        private:
            ...
            #elif defined(CPPCMS_BOOST_NO_STD_LOCALE)
    ...
    namespace detail // optimized stream wrapper
    {
        ...
        private:
            ...
            static void widen_and_assign(wchar_t* p, char ch)
            {
                // TODO: use BOOST_NO_STD_LOCALE
                std::locale loc;
                wchar_t w = CPPCMS_BOOST_USE_FACET(std::ctype<wchar_t>, loc).widen(ch);
                Traits::assign(*p, w);
            }
        ...
        public: // output
            ...
            bool operator<<(bool);
            bool operator<<(char);
#if !defined(CPPCMS_BOOST_LCAST_NO_WCHAR_T) && !defined(CPPCMS_BOOST_NO_INTRINSIC_WCHAR_T)
...
#if defined(CPPCMS_BOOST_HAS_LONG_LONG)
            bool operator<<(cppcms_boost::ulong_long_type);
            bool operator<<(cppcms_boost::long_long_type );
#elif defined(CPPCMS_BOOST_HAS_MS_INT64)
...
// This #if is in sync with lcast_streambuf_for_target
        ...
        template<typename CharT, class Base, class Traits>
        inline bool lexical_stream_limited_src<CharT,Base,Traits>::operator<<(
                cppcms_boost::ulong_long_type n)
        {
            start = lcast_put_unsigned<Traits>(n, finish);
            return true;
        }
...
# pragma warning( disable : 4702 ) // unreachable code
        ...
        template< typename Target
                ...
                >
        Target lexical_cast(
            CPPCMS_BOOST_DEDUCED_TYPENAME cppcms_boost::call_traits<Source>::param_type arg,
            CharT* buf, std::size_t src_len)
        {
            typedef CPPCMS_BOOST_DEDUCED_TYPENAME
                deduce_char_traits<CharT,Target,Source>::type traits;

            typedef CPPCMS_BOOST_DEDUCED_TYPENAME cppcms_boost::mpl::if_c<
            ...
            CPPCMS_BOOST_DEDUCED_TYPENAME cppcms_boost::mpl::if_c<
                Unlimited
            ...
            if(!(interpreter << arg && interpreter >> result))
                CPPCMS_BOOST_LCAST_THROW_BAD_CAST(Source, Target);
            return result;
        }
#if (defined _MSC_VER)
# pragma warning( pop )
    ...
    {
        typedef typename detail::widest_char< 
            CPPCMS_BOOST_DEDUCED_TYPENAME detail::stream_char<Target>::type 
          , CPPCMS_BOOST_DEDUCED_TYPENAME detail::stream_char<Source>::type 
        >::type char_type; 
...
#undef CPPCMS_BOOST_LCAST_NO_WCHAR_T
#endif
