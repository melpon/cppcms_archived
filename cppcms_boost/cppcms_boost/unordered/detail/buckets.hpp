...
#ifndef CPPCMS_BOOST_UNORDERED_DETAIL_MANAGER_HPP_INCLUDED
#define CPPCMS_BOOST_UNORDERED_DETAIL_MANAGER_HPP_INCLUDED

#include <cppcms_boost/config.hpp>
#include <cppcms_boost/assert.hpp>
#include <cppcms_boost/unordered/detail/node.hpp>
#include <cppcms_boost/unordered/detail/util.hpp>
...
namespace cppcms_boost { namespace unordered_detail {
    ...
    template <class A, class G>
    inline CPPCMS_BOOST_DEDUCED_TYPENAME hash_buckets<A, G>::bucket_ptr
    ...
    template <class A, class G>
    inline CPPCMS_BOOST_DEDUCED_TYPENAME hash_buckets<A, G>::node_ptr
    ...
    inline void hash_buckets<A, G>::delete_node(node_ptr b)
    {
        ...
        cppcms_boost::unordered_detail::destroy(raw_ptr->value_ptr());
    ...
    {
        CPPCMS_BOOST_ASSERT(node_alloc() == other.node_alloc());
        if(this->buckets_) { this->delete_buckets(); }
