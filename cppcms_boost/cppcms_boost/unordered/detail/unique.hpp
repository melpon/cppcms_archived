...
#ifndef CPPCMS_BOOST_UNORDERED_DETAIL_UNIQUE_HPP_INCLUDED
#define CPPCMS_BOOST_UNORDERED_DETAIL_UNIQUE_HPP_INCLUDED

#include <cppcms_boost/unordered/detail/table.hpp>
#include <cppcms_boost/unordered/detail/extract_key.hpp>
...
namespace cppcms_boost { namespace unordered_detail {
    ...
    public:
        ...
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::table table;
...
#define CPPCMS_BOOST_UNORDERED_INSERT_IMPL(z, n, _)                                   \
        template <CPPCMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, n)>                         \
        ...
        CPPCMS_BOOST_PP_REPEAT_FROM_TO(1, CPPCMS_BOOST_UNORDERED_EMPLACE_LIMIT,
            CPPCMS_BOOST_UNORDERED_INSERT_IMPL, _)

#undef CPPCMS_BOOST_UNORDERED_INSERT_IMPL
    ...
    struct set : public types<
        ...
        CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type,
        H, P, A,
        set_extractor<CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type>,
        ungrouped>
    {        
    ...
    struct map : public types<
        K, CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type,
        H, P, A,
        map_extractor<K, CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type>,
        ungrouped>
    {
        ...
        ::equals(hash_unique_table<T> const& other) const
    {
        ...
        for(bucket_ptr i = this->cached_begin_bucket_; i != end; ++i)
        {
            ...
            while(CPPCMS_BOOST_UNORDERED_BORLAND_BOOL(it1))
            {
                node_ptr it2 = other.find_iterator(this->get_key_from_ptr(it1));
                if(!CPPCMS_BOOST_UNORDERED_BORLAND_BOOL(it2)) return false;
    ...
    template <class T>
    inline CPPCMS_BOOST_DEDUCED_TYPENAME hash_unique_table<T>::node_ptr
    ...
    // strong otherwise
    template <class T>
    CPPCMS_BOOST_DEDUCED_TYPENAME hash_unique_table<T>::value_type&
        hash_unique_table<T>::operator[](key_type const& k)
    {
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME value_type::second_type mapped_type;
        ...
        if (CPPCMS_BOOST_UNORDERED_BORLAND_BOOL(pos)) {
    ...
    template <class T>
    inline CPPCMS_BOOST_DEDUCED_TYPENAME hash_unique_table<T>::emplace_return
...
#define CPPCMS_BOOST_UNORDERED_INSERT_IMPL(z, num_params, _)                          \
    template <class T>                                                         \
    template <CPPCMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, num_params)>                    \
    inline CPPCMS_BOOST_DEDUCED_TYPENAME                                              \
    ...
    {                                                                          \
        ...
        if (CPPCMS_BOOST_UNORDERED_BORLAND_BOOL(pos)) {                               \
            ...
            node_constructor a(*this);                                         \
            a.construct(CPPCMS_BOOST_UNORDERED_CALL_PARAMS(z, num_params));           \
                                                                               \
            if(this->reserve_for_insert(this->size_ + 1))                      \
                bucket = this->bucket_ptr_from_hash(hash_value);               \
                                                                               \
...
#undef CPPCMS_BOOST_UNORDERED_INSERT_IMPL
    ...
    template <class T>
    template<class... Args>
    CPPCMS_BOOST_DEDUCED_TYPENAME hash_unique_table<T>::emplace_return
...
#define CPPCMS_BOOST_UNORDERED_INSERT_IMPL(z, num_params, _)                          \
    ...
    CPPCMS_BOOST_PP_REPEAT_FROM_TO(2, CPPCMS_BOOST_UNORDERED_EMPLACE_LIMIT,
        CPPCMS_BOOST_UNORDERED_INSERT_IMPL, _)
