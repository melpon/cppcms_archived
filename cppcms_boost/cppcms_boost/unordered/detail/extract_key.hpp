...
#ifndef CPPCMS_BOOST_UNORDERED_DETAIL_EXTRACT_KEY_HPP_INCLUDED
#define CPPCMS_BOOST_UNORDERED_DETAIL_EXTRACT_KEY_HPP_INCLUDED
...
namespace unordered_detail {
    ...
    {
        typedef ValueType value_type;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME cppcms_boost::remove_const<Key>::type key_type;
