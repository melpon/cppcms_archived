...
#ifndef CPPCMS_BOOST_UNORDERED_DETAIL_FWD_HPP_INCLUDED
#define CPPCMS_BOOST_UNORDERED_DETAIL_FWD_HPP_INCLUDED

#include <cppcms_boost/config.hpp>
#include <cppcms_boost/iterator.hpp>
#include <cppcms_boost/compressed_pair.hpp>
#include <cppcms_boost/type_traits/aligned_storage.hpp>
#include <cppcms_boost/type_traits/alignment_of.hpp>
#include <cppcms_boost/unordered/detail/allocator_helpers.hpp>
#include <algorithm>
...
#if !defined(CPPCMS_BOOST_NO_RVALUE_REFERENCES) && !defined(CPPCMS_BOOST_NO_VARIADIC_TEMPLATES)
#   if defined(__SGI_STL_PORT) || defined(_STLPORT_VERSION)
        // STLport doesn't have std::forward.
#   else
#       define CPPCMS_BOOST_UNORDERED_STD_FORWARD
#   endif
#endif

#if !defined(CPPCMS_BOOST_UNORDERED_EMPLACE_LIMIT)
#define CPPCMS_BOOST_UNORDERED_EMPLACE_LIMIT 10
#endif
...
#define CPPCMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, num_params) \
    CPPCMS_BOOST_PP_ENUM_PARAMS_Z(z, num_params, class Arg)
#define CPPCMS_BOOST_UNORDERED_FUNCTION_PARAMS(z, num_params) \
    CPPCMS_BOOST_PP_ENUM_BINARY_PARAMS_Z(z, num_params, Arg, const& arg)
#define CPPCMS_BOOST_UNORDERED_CALL_PARAMS(z, num_params) \
    CPPCMS_BOOST_PP_ENUM_PARAMS_Z(z, num_params, arg)
...
#pragma warning(pop)
    ...
    public:
        ...
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME
            cppcms_boost::unordered_detail::rebind_wrap<A, bucket>::type
            bucket_allocator;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME bucket_allocator::pointer bucket_ptr;
    ...
    struct ungrouped_node_base : hash_bucket<A> {
        typedef hash_bucket<A> bucket;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME bucket::bucket_ptr bucket_ptr;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME bucket::node_ptr node_ptr;
    ...
    struct value_base
    {
        ...
        CPPCMS_BOOST_DEDUCED_TYPENAME cppcms_boost::aligned_storage<
            sizeof(value_type),
            ::cppcms_boost::alignment_of<value_type>::value>::type data_;
    ...
    class hash_node :
        public G::CPPCMS_BOOST_NESTED_TEMPLATE base<A>::type,
        public value_base<CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type>
    {
    public:
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME hash_bucket<A>::node_ptr node_ptr;
    ...
    public:
        ...
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME iterator_base::node node;

        typedef CPPCMS_BOOST_DEDUCED_TYPENAME bucket::bucket_allocator
            bucket_allocator;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME bucket::bucket_ptr bucket_ptr;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME bucket::node_ptr node_ptr;

        typedef CPPCMS_BOOST_DEDUCED_TYPENAME rebind_wrap<value_allocator, node>::type
            node_allocator;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME node_allocator::pointer real_node_ptr;

        // Members

        bucket_ptr buckets_;
        std::size_t bucket_count_;
        cppcms_boost::compressed_pair<bucket_allocator, node_allocator> allocators_;
    ...
    class hash_buffered_functions
    {
        ...
        typedef cppcms_boost::compressed_pair<H, P> function_pair;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME cppcms_boost::aligned_storage<
            sizeof(function_pair),
            ::cppcms_boost::alignment_of<function_pair>::value>::type aligned_function;
        ...
        {
            cppcms_boost::unordered_detail::destroy((function_pair*)(&funcs_[which]));
        }
    ...
    public:
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::hasher hasher;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::key_equal key_equal;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::value_allocator value_allocator;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::key_type key_type;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::value_type value_type;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::buffered_functions base;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::buckets buckets;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::extractor extractor;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::node_constructor node_constructor;

        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::node node;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::bucket bucket;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::node_ptr node_ptr;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::bucket_ptr bucket_ptr;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::iterator_base iterator_base;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::node_allocator node_allocator;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME T::iterator_pair iterator_pair;
    ...
    public:
        ...
        static CPPCMS_BOOST_DEDUCED_TYPENAME Iterator::base const&
    ...
    class hash_local_iterator
        : public cppcms_boost::iterator <
            std::forward_iterator_tag,
            CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type,
            std::ptrdiff_t,
            CPPCMS_BOOST_DEDUCED_TYPENAME A::pointer,
            CPPCMS_BOOST_DEDUCED_TYPENAME A::reference>
    {
    public:
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
    ...
    private:
        ...
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::node_ptr node_ptr;
    ...
    public:
        ...
        CPPCMS_BOOST_DEDUCED_TYPENAME A::reference operator*() const {
    ...
    class hash_const_local_iterator
        : public cppcms_boost::iterator <
            ...
            CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type,
            std::ptrdiff_t,
            CPPCMS_BOOST_DEDUCED_TYPENAME A::const_pointer,
            CPPCMS_BOOST_DEDUCED_TYPENAME A::const_reference >
    {
    public:
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
    ...
    private:
        typedef hash_buckets<A, G> buckets;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::node_ptr ptr;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::node node;
    ...
    private:
        typedef hash_buckets<A, G> buckets;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::node node;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::iterator_base base;
    ...
    public:
        ...
        CPPCMS_BOOST_DEDUCED_TYPENAME A::const_reference operator*() const {
            return *base_;
        }
        value_type const* operator->() const {
            return &*base_;
    ...
    public:
        ...
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::node node;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::bucket bucket;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::node_ptr node_ptr;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::bucket_ptr bucket_ptr;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::iterator_base iterator_base;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME buckets::node_allocator node_allocator;
