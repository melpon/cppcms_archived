...
#ifndef CPPCMS_BOOST_UNORDERED_UNORDERED_SET_HPP_INCLUDED
#define CPPCMS_BOOST_UNORDERED_UNORDERED_SET_HPP_INCLUDED

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
# pragma once
#endif

#include <cppcms_boost/unordered/unordered_set_fwd.hpp>
...
namespace cppcms_boost
{
    ...
    private:
        ...
        typedef cppcms_boost::unordered_detail::set<H, P,
...
#else
        unordered_set(cppcms_boost::unordered_detail::move_from<
...
#undef CPPCMS_BOOST_UNORDERED_EMPLACE
    ...
    private:
        ...
        typedef cppcms_boost::unordered_detail::multiset<H, P,
            value_allocator> types;
        typedef CPPCMS_BOOST_DEDUCED_TYPENAME types::impl table;
...
#else
        unordered_multiset(cppcms_boost::unordered_detail::move_from<
...
#define CPPCMS_BOOST_UNORDERED_EMPLACE(z, n, _)                                       \
            ...
            {                                                                  \
                return iterator(                                               \
                    table_.emplace(CPPCMS_BOOST_UNORDERED_CALL_PARAMS(z, n)));        \
            }                                                                  \
                                                                               \
            template <                                                         \
                CPPCMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, n)                            \
