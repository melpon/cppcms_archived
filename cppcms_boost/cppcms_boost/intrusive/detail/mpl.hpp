...
#ifndef CPPCMS_BOOST_INTRUSIVE_DETAIL_MPL_HPP
#define CPPCMS_BOOST_INTRUSIVE_DETAIL_MPL_HPP
...
#if defined(CPPCMS_BOOST_MSVC) || defined(__BORLANDC_)
#define CPPCMS_BOOST_INTRUSIVE_TT_DECL __cdecl
#else
#define CPPCMS_BOOST_INTRUSIVE_TT_DECL 
#endif

#if defined(_MSC_EXTENSIONS) && !defined(__BORLAND__) && !defined(_WIN64)
#define CPPCMS_BOOST_INTRUSIVE_TT_TEST_MSC_FUNC_SIGS
#endif
...
#ifdef CPPCMS_BOOST_INTRUSIVE_TT_TEST_MSC_FUNC_SIGS
