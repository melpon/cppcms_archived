...
#ifndef CPPCMS_BOOST_INTRUSIVE_GENERIC_HOOK_HPP
#define CPPCMS_BOOST_INTRUSIVE_GENERIC_HOOK_HPP
   ...
   /// @endcond
{
   ...
   public:
   struct cppcms_boost_intrusive_tags
   {
   ...
   generic_hook()
   {
      if(cppcms_boost_intrusive_tags::safemode_or_autounlink){
   ...
   {
      destructor_impl
         (*this, detail::link_dispatch<cppcms_boost_intrusive_tags::link_mode>());
   }
   ...
   bool is_linked() const 
   {
      ...
      CPPCMS_BOOST_STATIC_ASSERT(( cppcms_boost_intrusive_tags::safemode_or_autounlink ));
   ...
   void unlink()
   {
      CPPCMS_BOOST_STATIC_ASSERT(( (int)cppcms_boost_intrusive_tags::link_mode == (int)auto_unlink ));
