...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef CPPCMS_BOOST_INTRUSIVE_RBTREE_HPP
#define CPPCMS_BOOST_INTRUSIVE_RBTREE_HPP
...
#include <cppcms_boost/intrusive/set_hook.hpp>
#include <cppcms_boost/intrusive/detail/rbtree_node.hpp>
#include <cppcms_boost/intrusive/detail/tree_node.hpp>
...
#include <cppcms_boost/intrusive/detail/function_detector.hpp>
   ...
   :  private detail::clear_on_destructor_base<rbtree_impl<Config> >
{
   ...
   iterator insert_equal(reference value)
   {
      ...
      if(safemode_or_autounlink)
         CPPCMS_BOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(node_algorithms::unique(to_insert));
   ...
   iterator erase(const_iterator i)
   {
      ...
      if(safemode_or_autounlink)
         CPPCMS_BOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(!node_algorithms::unique(to_erase));
   ...
   {
      CPPCMS_BOOST_STATIC_ASSERT((!constant_time_size));
