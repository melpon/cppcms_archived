...
#ifndef CPPCMS_BOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP
#define CPPCMS_BOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP

#include <cppcms_boost/intrusive/detail/mpl.hpp> //ls_zeros
#include <cppcms_boost/intrusive/detail/assert.hpp> //BOOST_INTRUSIVE_INVARIANT_ASSERT
...
struct pointer_plus_bits<T*, NumBits>
{
   ...
   {
      CPPCMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(0 == (std::size_t(p) & Mask));
   ...
   {
      CPPCMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(c <= Mask);
