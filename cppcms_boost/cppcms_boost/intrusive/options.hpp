...
#ifndef CPPCMS_BOOST_INTRUSIVE_OPTIONS_HPP
#define CPPCMS_BOOST_INTRUSIVE_OPTIONS_HPP
...
#define CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER) \
struct CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER : public default_hook_tag\
{\
   template <class T>\
   struct apply\
   {  typedef typename T::CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER type;  };\
}\

CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_list_hook);
CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_slist_hook);
CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_set_hook);
CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_uset_hook);
CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_avl_set_hook);
CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_splay_set_hook);
CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_bs_set_hook);

#undef CPPCMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION
...
{
   typedef typename BaseHook::cppcms_boost_intrusive_tags tags;
...
{  typedef typename BaseHook::cppcms_boost_intrusive_tags::node_traits type;  };
