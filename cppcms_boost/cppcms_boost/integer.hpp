...
#ifndef CPPCMS_BOOST_INTEGER_HPP
#define CPPCMS_BOOST_INTEGER_HPP

#include <cppcms_boost/integer_fwd.hpp>  // self include

#include <cppcms_boost/integer_traits.hpp>  // for boost::integer_traits
