...
#ifndef CPPCMS_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
#define CPPCMS_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED

#include <cppcms_boost/type_traits/intrinsics.hpp>
#ifndef CPPCMS_BOOST_IS_BASE_OF
...
namespace detail {
 ...
 && !CPPCMS_BOOST_WORKAROUND(__SUNPRO_CC , <= 0x540) \
...
#pragma warning(disable:6334)
    ...
    //
    CPPCMS_BOOST_STATIC_ASSERT(sizeof(B) != 0);
    CPPCMS_BOOST_STATIC_ASSERT(sizeof(D) != 0);
...
{
    CPPCMS_BOOST_STATIC_CONSTANT(bool, value =
        (::cppcms_boost::is_convertible<D*,B*>::value));
};

#define CPPCMS_BOOST_BROKEN_IS_BASE_AND_DERIVED
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::cppcms_boost::is_class<B>::value,
       ::cppcms_boost::is_class<D>::value,
       ::cppcms_boost::is_same<ncvB,ncvD>::value> selector;
    typedef typename selector::template rebind<ncvB,ncvD> binder;
    typedef typename binder::type bound_type;

    CPPCMS_BOOST_STATIC_CONSTANT(bool, value = bound_type::value);
};
#else
template <typename B, typename D>
struct is_base_and_derived_impl
{
    ...
    CPPCMS_BOOST_STATIC_CONSTANT(bool, value = (CPPCMS_BOOST_IS_BASE_OF(B,D) && ! ::cppcms_boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::cppcms_boost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )

#ifndef CPPCMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base,Derived&,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived&,false)
#endif

#if CPPCMS_BOOST_WORKAROUND(__CODEGEARC__, CPPCMS_BOOST_TESTED_AT(0x610))
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename Base,is_base_and_derived,Base,Base,false)
#endif
