...
#ifndef CPPCMS_BOOST_TT_IS_ARITHMETIC_HPP_INCLUDED
#define CPPCMS_BOOST_TT_IS_ARITHMETIC_HPP_INCLUDED

#if !defined( __CODEGEARC__ )
#include <cppcms_boost/type_traits/is_integral.hpp>
#include <cppcms_boost/type_traits/is_float.hpp>
...
#if defined(__CODEGEARC__)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_arithmetic,T,__is_arithmetic(T))
#else
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_arithmetic,T,::cppcms_boost::detail::is_arithmetic_impl<T>::value)
#endif
