...
#ifndef CPPCMS_BOOST_TT_IS_POINTER_HPP_INCLUDED
#define CPPCMS_BOOST_TT_IS_POINTER_HPP_INCLUDED
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pointer,T,__is_pointer(T))
...
{ \
    CPPCMS_BOOST_STATIC_CONSTANT(bool, value = result); \
}; \
/**/
...
struct is_pointer_impl
{
    ...
    CPPCMS_BOOST_STATIC_CONSTANT(bool, value =
        (::cppcms_boost::type_traits::ice_and<
              ::cppcms_boost::detail::is_pointer_helper<T>::value
    ...
    CPPCMS_BOOST_STATIC_CONSTANT(bool, value =
        (::cppcms_boost::type_traits::ice_and<
        ::cppcms_boost::detail::is_pointer_helper<typename remove_cv<T>::type>::value
            , ::cppcms_boost::type_traits::ice_not<
                ::cppcms_boost::is_member_pointer<T>::value
                >::value
            >::value)
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pointer,T,::cppcms_boost::detail::is_pointer_impl<T>::value)

#if defined(__BORLANDC__) && !defined(__COMO__) && (__BORLANDC__ < 0x600)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_pointer,T&,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_pointer,T& const,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_pointer,T& volatile,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_pointer,T& const volatile,false)
#endif
...
yes_type CPPCMS_BOOST_TT_DECL is_pointer_tester(pointer_helper);
no_type CPPCMS_BOOST_TT_DECL is_pointer_tester(...);
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pointer,void,false)
#ifndef CPPCMS_BOOST_NO_CV_VOID_SPECIALIZATIONS
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pointer,void const,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pointer,void volatile,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pointer,void const volatile,false)
#endif
