#ifndef CPPCMS_BOOST_TT_IS_ABSTRACT_CLASS_HPP
#define CPPCMS_BOOST_TT_IS_ABSTRACT_CLASS_HPP
...
#ifndef CPPCMS_BOOST_IS_ABSTRACT
...
#include <cppcms_boost/type_traits/is_polymorphic.hpp>
#endif
#endif
...
#ifdef CPPCMS_BOOST_IS_ABSTRACT
template <class T>
struct is_abstract_imp
{
   CPPCMS_BOOST_STATIC_CONSTANT(bool, value = CPPCMS_BOOST_IS_ABSTRACT(T));
};
#elif !defined(CPPCMS_BOOST_NO_IS_ABSTRACT)
template<class T>
struct is_abstract_imp2
{
   ...
   //
   CPPCMS_BOOST_STATIC_ASSERT(sizeof(T) != 0);

   // GCC2 won't even parse this template if we embed the computation
   // of s1 in the computation of value.
#ifdef __GNUC__
   CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, s1 = sizeof(is_abstract_imp2<T>::template check_sig<T>(0)));
#else
#if CPPCMS_BOOST_WORKAROUND(CPPCMS_BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(push)
#pragma warning(disable:6334)
#endif
   CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, s1 = sizeof(check_sig<T>(0)));
#if CPPCMS_BOOST_WORKAROUND(CPPCMS_BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(pop)
#endif
#endif
...
struct is_abstract_imp
{
   typedef is_abstract_select< ::cppcms_boost::is_class<T>::value> selector;
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::cppcms_boost::detail::is_abstract_imp<T>::value)
#else
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::cppcms_boost::detail::is_polymorphic_imp<T>::value)
#endif
