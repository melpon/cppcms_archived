...
#ifndef CPPCMS_BOOST_TT_ADD_CONST_HPP_INCLUDED
#define CPPCMS_BOOST_TT_ADD_CONST_HPP_INCLUDED
...
CPPCMS_BOOST_TT_AUX_TYPE_TRAIT_DEF1(add_const,T,T const)
...
CPPCMS_BOOST_TT_AUX_TYPE_TRAIT_PARTIAL_SPEC1_1(typename T,add_const,T&,T&)
#endif
