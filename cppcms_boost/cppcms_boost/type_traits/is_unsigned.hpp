...
#ifndef CPPCMS_BOOST_TT_IS_UNSIGNED_HPP_INCLUDED
#define CPPCMS_BOOST_TT_IS_UNSIGNED_HPP_INCLUDED
...
#if defined( __CODEGEARC__ )
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,__is_unsigned(T))
#else
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::cppcms_boost::detail::is_unsigned_imp<T>::value)
#endif
