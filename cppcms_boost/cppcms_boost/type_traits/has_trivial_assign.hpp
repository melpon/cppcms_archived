...
#ifndef CPPCMS_BOOST_TT_HAS_TRIVIAL_ASSIGN_HPP_INCLUDED
#define CPPCMS_BOOST_TT_HAS_TRIVIAL_ASSIGN_HPP_INCLUDED
   ...
   CPPCMS_BOOST_STATIC_CONSTANT(bool, value =
      (::cppcms_boost::type_traits::ice_and<
         ::cppcms_boost::type_traits::ice_or<
            ...
            CPPCMS_BOOST_HAS_TRIVIAL_ASSIGN(T)
         >::value,
      ::cppcms_boost::type_traits::ice_not< ::cppcms_boost::is_const<T>::value >::value,
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_assign,T,::cppcms_boost::detail::has_trivial_assign_impl<T>::value)
