...
#ifndef CPPCMS_BOOST_TT_HAS_NOTHROW_ASSIGN_HPP_INCLUDED
#define CPPCMS_BOOST_TT_HAS_NOTHROW_ASSIGN_HPP_INCLUDED
...
struct has_nothrow_assign_imp{
   CPPCMS_BOOST_STATIC_CONSTANT(bool, value = 
      (::cppcms_boost::type_traits::ice_or<
         ::cppcms_boost::has_trivial_assign<T>::value,
         CPPCMS_BOOST_HAS_NOTHROW_ASSIGN(T)
      >::value));
};

}

CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_assign,T,::cppcms_boost::detail::has_nothrow_assign_imp<T>::value)
