...
#ifndef CPPCMS_BOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
#define CPPCMS_BOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
no_type CPPCMS_BOOST_TT_DECL is_function_ptr_tester(...);
...
#define CPPCMS_BOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "cppcms_boost/type_traits/detail/is_function_ptr_tester.hpp"))
...
yes_type is_function_ptr_tester(R (*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T)));
@#ifndef CPPCMS_BOOST_TT_NO_ELLIPSIS_IN_FUNC_TESTING
template <class R CPPCMS_BOOST_PP_COMMA_IF(CPPCMS_BOOST_PP_COUNTER) CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T) ...));
@#endif
@#ifdef CPPCMS_BOOST_TT_TEST_MS_FUNC_SIGS
template <class R CPPCMS_BOOST_PP_COMMA_IF(CPPCMS_BOOST_PP_COUNTER) CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T)));
template <class R CPPCMS_BOOST_PP_COMMA_IF(CPPCMS_BOOST_PP_COUNTER) CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T) ...));
@#ifndef _MANAGED
template <class R CPPCMS_BOOST_PP_COMMA_IF(CPPCMS_BOOST_PP_COUNTER) CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T)));
template <class R CPPCMS_BOOST_PP_COMMA_IF(CPPCMS_BOOST_PP_COUNTER) CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T) ...));
@#endif
template <class R CPPCMS_BOOST_PP_COMMA_IF(CPPCMS_BOOST_PP_COUNTER) CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T)));
template <class R CPPCMS_BOOST_PP_COMMA_IF(CPPCMS_BOOST_PP_COUNTER) CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(CPPCMS_BOOST_PP_ENUM_PARAMS(CPPCMS_BOOST_PP_COUNTER,T) ...));
@#endif
