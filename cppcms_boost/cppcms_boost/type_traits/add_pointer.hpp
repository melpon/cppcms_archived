...
#ifndef CPPCMS_BOOST_TT_ADD_POINTER_HPP_INCLUDED
#define CPPCMS_BOOST_TT_ADD_POINTER_HPP_INCLUDED
...
CPPCMS_BOOST_TT_AUX_TYPE_TRAIT_DEF1(add_pointer,T,typename cppcms_boost::detail::add_pointer_impl<T>::type)
