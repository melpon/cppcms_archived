...
#ifndef CPPCMS_BOOST_TT_HAS_TRIVIAL_DESTRUCTOR_HPP_INCLUDED
#define CPPCMS_BOOST_TT_HAS_TRIVIAL_DESTRUCTOR_HPP_INCLUDED
...
struct has_trivial_dtor_impl
{
   CPPCMS_BOOST_STATIC_CONSTANT(bool, value =
      (::cppcms_boost::type_traits::ice_or<
         ...
         CPPCMS_BOOST_HAS_TRIVIAL_DESTRUCTOR(T)
      >::value));
};

} // namespace detail

CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_destructor,T,::cppcms_boost::detail::has_trivial_dtor_impl<T>::value)
