...
#ifndef CPPCMS_BOOST_TT_IS_SAME_HPP_INCLUDED
#define CPPCMS_BOOST_TT_IS_SAME_HPP_INCLUDED
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_same,T,U,false)
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename T,is_same,T,T,true)
...
template <typename T>
::cppcms_boost::type_traits::yes_type
CPPCMS_BOOST_TT_DECL is_same_tester(T*, T*);

::cppcms_boost::type_traits::no_type
CPPCMS_BOOST_TT_DECL is_same_tester(...);
...
struct is_same_impl
{
   ...
   CPPCMS_BOOST_STATIC_CONSTANT(bool, value =
      (::cppcms_boost::type_traits::ice_and<
         ...
         (::cppcms_boost::is_reference<T>::value == ::cppcms_boost::is_reference<U>::value),
         (sizeof(T) == sizeof(U))
        >::value));
};
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_same,T,U,(::cppcms_boost::detail::is_same_impl<T,U>::value))
