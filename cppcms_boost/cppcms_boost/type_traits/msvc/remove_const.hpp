...
#ifndef CPPCMS_BOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
#define CPPCMS_BOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
...
namespace cppcms_boost {
    namespace detail {
        ...
        struct remove_const_impl_typeof<true,false,true,false> {
            ...
            struct inner {
                ...
                static msvc_register_type<T,ID> test(...);
                CPPCMS_BOOST_STATIC_CONSTANT(unsigned,register_test=sizeof(test( (void(*)(T))(NULL) ) ));
                typedef typename msvc_extract_type<ID>::id2type::type type;
            };
            template<typename T>
            struct transform_type {
        ...
        struct remove_const_impl_typeof<false,true,true,false> {
            template<typename T,typename ID>
            struct inner {
                CPPCMS_BOOST_STATIC_CONSTANT(unsigned,value=(sizeof(T)/sizeof((*((T*)NULL))[0])));
    ...
    struct remove_const {
        ...
        typedef typename 
            ...
            >::type
        type;
        CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_const,T)
    };
}//namespace boost
