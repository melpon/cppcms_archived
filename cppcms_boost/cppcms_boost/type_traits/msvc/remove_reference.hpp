...
#ifndef CPPCMS_BOOST_TYPE_TRAITS_MSVC_REMOVE_REFERENCE_HOLT_2004_0827
#define CPPCMS_BOOST_TYPE_TRAITS_MSVC_REMOVE_REFERENCE_HOLT_2004_0827
...
namespace cppcms_boost {
    ...
    struct remove_reference {
        ...
        CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_reference,T)
    };
} //namespace boost
