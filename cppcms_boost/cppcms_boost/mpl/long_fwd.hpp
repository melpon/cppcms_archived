...
#ifndef CPPCMS_BOOST_MPL_LONG_FWD_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_LONG_FWD_HPP_INCLUDED
...
template< CPPCMS_BOOST_MPL_AUX_NTTP_DECL(long, N) > struct long_;

CPPCMS_BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
CPPCMS_BOOST_MPL_AUX_ADL_BARRIER_DECL(long_)
