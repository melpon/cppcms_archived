...
#ifndef CPPCMS_BOOST_MPL_ARG_FWD_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_ARG_FWD_HPP_INCLUDED
...
template< CPPCMS_BOOST_MPL_AUX_NTTP_DECL(int, N) > struct arg;

CPPCMS_BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
CPPCMS_BOOST_MPL_AUX_ADL_BARRIER_DECL(arg)
