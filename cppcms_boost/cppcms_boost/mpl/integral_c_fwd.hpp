...
#ifndef CPPCMS_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
...
CPPCMS_BOOST_MPL_AUX_ADL_BARRIER_DECL(integral_c)
