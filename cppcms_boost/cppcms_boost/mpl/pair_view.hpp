...
#ifndef CPPCMS_BOOST_MPL_PAIR_VIEW_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_PAIR_VIEW_HPP_INCLUDED
...
#include <cppcms_boost/mpl/iterator_category.hpp>
#include <cppcms_boost/mpl/advance.hpp>
#include <cppcms_boost/mpl/distance.hpp>
#include <cppcms_boost/mpl/next_prior.hpp>
#include <cppcms_boost/mpl/deref.hpp>
#include <cppcms_boost/mpl/min_max.hpp>
#include <cppcms_boost/mpl/pair.hpp>
#include <cppcms_boost/mpl/iterator_tags.hpp>
...
template<
      typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(Sequence1)
    , typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(Sequence2)
    >
struct pair_view
{
...
CPPCMS_BOOST_MPL_AUX_NA_SPEC(2, pair_view)
