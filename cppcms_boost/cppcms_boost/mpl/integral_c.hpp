...
#ifndef CPPCMS_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
...
#include <cppcms_boost/mpl/integral_c_fwd.hpp>
...
#if CPPCMS_BOOST_WORKAROUND(__HP_aCC, <= 53800)
...
#include <cppcms_boost/mpl/aux_/integral_wrapper.hpp>
