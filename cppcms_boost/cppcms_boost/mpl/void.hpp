...
#ifndef CPPCMS_BOOST_MPL_VOID_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_VOID_HPP_INCLUDED
...
CPPCMS_BOOST_MPL_AUX_NA_SPEC(1, is_void_)
CPPCMS_BOOST_MPL_AUX_NA_SPEC(1, is_not_void_)
