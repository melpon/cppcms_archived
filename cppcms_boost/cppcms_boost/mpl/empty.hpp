...
#ifndef CPPCMS_BOOST_MPL_EMPTY_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_EMPTY_HPP_INCLUDED
...
#include <cppcms_boost/mpl/empty_fwd.hpp>
#include <cppcms_boost/mpl/sequence_tag.hpp>
#include <cppcms_boost/mpl/aux_/empty_impl.hpp>
...
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,empty,(Sequence))
};

CPPCMS_BOOST_MPL_AUX_NA_SPEC(1, empty)
