...
#ifndef CPPCMS_BOOST_MPL_ALWAYS_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_ALWAYS_HPP_INCLUDED
...
template< typename Value > struct always
{
    template<
          typename T
        CPPCMS_BOOST_MPL_PP_NESTED_DEF_PARAMS_TAIL(1, typename T, na)
        >
    struct apply
    {
        typedef Value type;
...
CPPCMS_BOOST_MPL_AUX_ARITY_SPEC(1, always)
