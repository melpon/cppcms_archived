...
#ifndef CPPCMS_BOOST_MPL_MIN_MAX_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_MIN_MAX_HPP_INCLUDED
...
CPPCMS_BOOST_MPL_AUX_NA_SPEC(2, min)
CPPCMS_BOOST_MPL_AUX_NA_SPEC(2, max)
