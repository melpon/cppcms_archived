...
#ifndef CPPCMS_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
...
#include <cppcms_boost/mpl/aux_/config/arrays.hpp>
...
template< CPPCMS_BOOST_MPL_AUX_NTTP_DECL(long, n) > struct weighted_tag
{
...
#if defined(CPPCMS_BOOST_MPL_CFG_NO_DEPENDENT_ARRAY_TYPES)
