...
#ifndef CPPCMS_BOOST_MPL_AUX_FOLD_IMPL_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_FOLD_IMPL_HPP_INCLUDED
...
#   define CPPCMS_BOOST_MPL_PREPROCESSED_HEADER fold_impl.hpp
