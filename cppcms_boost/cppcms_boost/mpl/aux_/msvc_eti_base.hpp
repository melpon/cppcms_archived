...
#ifndef CPPCMS_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
...
template< typename T > struct msvc_eti_base
    : T
{
#if CPPCMS_BOOST_WORKAROUND(CPPCMS_BOOST_MPL_CFG_GCC, CPPCMS_BOOST_TESTED_AT(0x0304))
    msvc_eti_base();
#endif
    typedef T type;
};
