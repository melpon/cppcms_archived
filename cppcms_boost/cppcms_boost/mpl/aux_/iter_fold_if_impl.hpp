...
#ifndef CPPCMS_BOOST_MPL_AUX_ITER_FOLD_IF_IMPL_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_ITER_FOLD_IF_IMPL_HPP_INCLUDED
...
#   define CPPCMS_BOOST_MPL_PREPROCESSED_HEADER iter_fold_if_impl.hpp
...
struct iter_fold_if_forward_step
{
    ...
    typedef typename iter_fold_if_step_impl<
          CPPCMS_BOOST_MPL_AUX_MSVC_VALUE_WKND(not_last)::value
...
#   define AUX_ITER_FOLD_FORWARD_STEP(unused, i, unused2) \
    typedef iter_fold_if_forward_step< \
          typename CPPCMS_BOOST_PP_CAT(forward_step,i)::iterator \
        , typename CPPCMS_BOOST_PP_CAT(forward_step,i)::state \
        , ForwardOp \
        , ForwardPredicate \
        > CPPCMS_BOOST_PP_CAT(forward_step, CPPCMS_BOOST_PP_INC(i)); \
    /**/

#   define AUX_ITER_FOLD_BACKWARD_STEP_FUNC(i) \
    typedef iter_fold_if_backward_step< \
          typename CPPCMS_BOOST_PP_CAT(forward_step,CPPCMS_BOOST_PP_DEC(i))::iterator \
        , typename CPPCMS_BOOST_PP_CAT(backward_step,i)::state \
        , BackwardOp \
        , BackwardPredicate \
        > CPPCMS_BOOST_PP_CAT(backward_step,CPPCMS_BOOST_PP_DEC(i)); \
    /**/

#   define AUX_ITER_FOLD_BACKWARD_STEP(unused, i, unused2) \
    AUX_ITER_FOLD_BACKWARD_STEP_FUNC( \
        CPPCMS_BOOST_PP_SUB_D(1,CPPCMS_BOOST_MPL_LIMIT_UNROLLING,i) \
        ) \
    /**/

#   define AUX_LAST_FORWARD_STEP \
    CPPCMS_BOOST_PP_CAT(forward_step, CPPCMS_BOOST_MPL_LIMIT_UNROLLING) \
    /**/

#   define AUX_LAST_BACKWARD_STEP \
    CPPCMS_BOOST_PP_CAT(backward_step, CPPCMS_BOOST_MPL_LIMIT_UNROLLING) \
    /**/
