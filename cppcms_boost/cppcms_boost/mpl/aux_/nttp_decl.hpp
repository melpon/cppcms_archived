...
#ifndef CPPCMS_BOOST_MPL_AUX_NTTP_DECL_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_NTTP_DECL_HPP_INCLUDED
...
#if defined(CPPCMS_BOOST_MPL_CFG_NTTP_BUG)
...
#   define CPPCMS_BOOST_MPL_AUX_NTTP_DECL(T, x) CPPCMS_BOOST_PP_CAT(_mpl_nttp_,T) x /**/

#else

#   define CPPCMS_BOOST_MPL_AUX_NTTP_DECL(T, x) T x /**/
