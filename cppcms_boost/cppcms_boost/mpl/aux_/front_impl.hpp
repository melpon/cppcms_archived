...
#ifndef CPPCMS_BOOST_MPL_AUX_FRONT_IMPL_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_FRONT_IMPL_HPP_INCLUDED
...
CPPCMS_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1,front_impl)
