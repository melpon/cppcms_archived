...
#ifndef CPPCMS_BOOST_MPL_AUX_CONFIG_DMC_AMBIGUOUS_CTPS_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_CONFIG_DMC_AMBIGUOUS_CTPS_HPP_INCLUDED
...
#   define CPPCMS_BOOST_MPL_CFG_DMC_AMBIGUOUS_CTPS
