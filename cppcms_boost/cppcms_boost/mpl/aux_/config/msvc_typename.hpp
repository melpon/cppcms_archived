...
#ifndef CPPCMS_BOOST_MPL_AUX_CONFIG_MSVC_TYPENAME_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_CONFIG_MSVC_TYPENAME_HPP_INCLUDED
...
#   define CPPCMS_BOOST_MSVC_TYPENAME
#else
#   define CPPCMS_BOOST_MSVC_TYPENAME typename
#endif
