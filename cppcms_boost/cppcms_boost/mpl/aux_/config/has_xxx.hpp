...
#ifndef CPPCMS_BOOST_MPL_AUX_CONFIG_HAS_XXX_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_CONFIG_HAS_XXX_HPP_INCLUDED
...
// agurt, 11/jan/03: signals a stub-only 'has_xxx' implementation
    ...
    && (   defined(CPPCMS_BOOST_MPL_CFG_BROKEN_OVERLOAD_RESOLUTION) \
        || CPPCMS_BOOST_WORKAROUND(__GNUC__, <= 2) \
        || CPPCMS_BOOST_WORKAROUND(__DMC__, CPPCMS_BOOST_TESTED_AT(0x840)) \
        )

#   define CPPCMS_BOOST_MPL_CFG_NO_HAS_XXX
