...
#ifndef CPPCMS_BOOST_MPL_AUX_CONFIG_ETI_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_CONFIG_ETI_HPP_INCLUDED
...
#   define CPPCMS_BOOST_MPL_CFG_MSVC_60_ETI_BUG
...
#   define CPPCMS_BOOST_MPL_CFG_MSVC_70_ETI_BUG
    ...
    && ( defined(CPPCMS_BOOST_MPL_CFG_MSVC_60_ETI_BUG) \
        || defined(CPPCMS_BOOST_MPL_CFG_MSVC_70_ETI_BUG) \
        )

#   define CPPCMS_BOOST_MPL_CFG_MSVC_ETI_BUG
