...
#ifndef CPPCMS_BOOST_MPL_AUX_CONFIG_ARRAYS_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_CONFIG_ARRAYS_HPP_INCLUDED
...
#   define CPPCMS_BOOST_MPL_CFG_NO_DEPENDENT_ARRAY_TYPES
