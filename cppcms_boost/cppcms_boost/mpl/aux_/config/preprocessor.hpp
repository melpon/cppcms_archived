...
#ifndef CPPCMS_BOOST_MPL_AUX_CONFIG_PREPROCESSOR_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_CONFIG_PREPROCESSOR_HPP_INCLUDED
...
#include <cppcms_boost/mpl/aux_/config/workaround.hpp>
    ...
    && (   CPPCMS_BOOST_WORKAROUND(__MWERKS__, <= 0x3003) \
        || CPPCMS_BOOST_WORKAROUND(__BORLANDC__, < 0x582) \
        || CPPCMS_BOOST_WORKAROUND(__IBMCPP__, CPPCMS_BOOST_TESTED_AT(502)) \
        )

#   define CPPCMS_BOOST_MPL_CFG_BROKEN_PP_MACRO_EXPANSION

#endif

#if !defined(CPPCMS_BOOST_MPL_CFG_NO_OWN_PP_PRIMITIVES)
#   define CPPCMS_BOOST_MPL_CFG_NO_OWN_PP_PRIMITIVES
#endif
