...
#ifndef CPPCMS_BOOST_MPL_AUX_CONFIG_LAMBDA_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_CONFIG_LAMBDA_HPP_INCLUDED
...
#   define CPPCMS_BOOST_MPL_CFG_NO_FULL_LAMBDA_SUPPORT
