...
#ifndef CPPCMS_BOOST_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
...
CPPCMS_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,begin_impl)
CPPCMS_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,end_impl)
