...
#ifndef CPPCMS_BOOST_MPL_AUX_HAS_APPLY_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_HAS_APPLY_HPP_INCLUDED
...
#include <cppcms_boost/mpl/aux_/config/has_apply.hpp>

namespace cppcms_boost { namespace mpl { namespace aux {
#if !defined(CPPCMS_BOOST_MPL_CFG_NO_HAS_APPLY)
CPPCMS_BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF(has_apply, apply, false)
#else
