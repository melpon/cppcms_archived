...
#ifndef CPPCMS_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
...
struct push_back_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        CPPCMS_BOOST_MPL_ASSERT_MSG(
              ( cppcms_boost::is_same< T, has_push_back_arg >::value )
...
CPPCMS_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, push_back_impl)
CPPCMS_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, has_push_back_impl)
