...
#   define AUX778076_ITER_FOLD_STEP(unused, i, unused2) \
    typedef typename apply2< \
          ForwardOp \
        , CPPCMS_BOOST_PP_CAT(state,i) \
        , AUX778076_FOLD_IMPL_OP(CPPCMS_BOOST_PP_CAT(iter,i)) \
        >::type CPPCMS_BOOST_PP_CAT(state,CPPCMS_BOOST_PP_INC(i)); \
    typedef typename mpl::next<CPPCMS_BOOST_PP_CAT(iter,i)>::type \
        CPPCMS_BOOST_PP_CAT(iter,CPPCMS_BOOST_PP_INC(i)); \
    /**/
...
/// forward declaration
template<
      CPPCMS_BOOST_MPL_AUX_NTTP_DECL(int, N)
    , typename First
    , typename Last
    , typename State
    , typename ForwardOp
...
#   define CPPCMS_BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, CPPCMS_BOOST_MPL_LIMIT_UNROLLING, <cppcms_boost/mpl/aux_/fold_impl_body.hpp>))
...
struct AUX778076_FOLD_CHUNK_NAME<-1>
{
    ...
    struct result_
    {
        typedef typename if_<
            ...
            , CPPCMS_BOOST_PP_CAT(AUX778076_FOLD_IMPL_NAME_PREFIX,_step)<First,Last,State,ForwardOp>
            >::type res_;
...
struct AUX778076_FOLD_IMPL_NAME<n_,First,Last,State,ForwardOp>
{
    ...
    CPPCMS_BOOST_MPL_PP_REPEAT(n_, AUX778076_ITER_FOLD_STEP, unused)

    typedef CPPCMS_BOOST_PP_CAT(state,n_) state;
