...
#ifndef CPPCMS_BOOST_MPL_ITERATOR_CATEGORY_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_ITERATOR_CATEGORY_HPP_INCLUDED
...
struct iterator_category
{
    ...
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,iterator_category,(Iterator))
};

CPPCMS_BOOST_MPL_AUX_NA_SPEC(1, iterator_category)
