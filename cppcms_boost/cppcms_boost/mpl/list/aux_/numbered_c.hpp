...
template<
      typename T
    , CPPCMS_BOOST_PP_ENUM_PARAMS(i, T C)
    >
struct list1_c
    : l_item<
          long_<1>
...
#   define MPL_AUX_LIST_C_TAIL(list, i, C) \
    CPPCMS_BOOST_PP_CAT(CPPCMS_BOOST_PP_CAT(list,CPPCMS_BOOST_PP_DEC(i)),_c)<T, \
      CPPCMS_BOOST_PP_ENUM_SHIFTED_PARAMS(i, C) \
    > \
    /**/
...
template<
    ...
    , CPPCMS_BOOST_PP_ENUM_PARAMS(i, T C)
    >
struct CPPCMS_BOOST_PP_CAT(CPPCMS_BOOST_PP_CAT(list,i),_c)
    : l_item<
          long_<i>
        , integral_c<T,C0>
        ...
        >
{
    typedef CPPCMS_BOOST_PP_CAT(CPPCMS_BOOST_PP_CAT(list,i),_c) type;
    typedef T value_type;
};
