...
#ifndef CPPCMS_BOOST_MPL_LIST_AUX_ITERATOR_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_LIST_AUX_ITERATOR_HPP_INCLUDED
...
#include <cppcms_boost/mpl/aux_/lambda_spec.hpp>
...
CPPCMS_BOOST_MPL_AUX_PASS_THROUGH_LAMBDA_SPEC(1, l_iter)
