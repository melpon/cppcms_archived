...
#ifndef CPPCMS_BOOST_MPL_TRANSFORM_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_TRANSFORM_HPP_INCLUDED
...
#include <cppcms_boost/mpl/fold.hpp>
#include <cppcms_boost/mpl/reverse_fold.hpp>
#include <cppcms_boost/mpl/pair_view.hpp>
...
#include <cppcms_boost/mpl/aux_/inserter_algorithm.hpp>
...
CPPCMS_BOOST_MPL_AUX_INSERTER_ALGORITHM_DEF(3, transform1)                    
CPPCMS_BOOST_MPL_AUX_INSERTER_ALGORITHM_DEF(4, transform2)
    
#define AUX778076_TRANSFORM_DEF(name)                                   \
template<                                                               \
      typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(Seq1)                             \
    , typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(Seq2OrOperation)                  \
    , typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(OperationOrInserter)              \
    , typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(Inserter)                         \
    >                                                                   \
struct name                                                             \
{                                                                       \
...
CPPCMS_BOOST_MPL_AUX_NA_SPEC(4, name)                                          \
/**/
