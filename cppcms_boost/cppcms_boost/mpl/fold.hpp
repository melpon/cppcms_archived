...
#ifndef CPPCMS_BOOST_MPL_FOLD_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_FOLD_HPP_INCLUDED
...
#include <cppcms_boost/mpl/aux_/fold_impl.hpp>
...
struct fold
{
    ...
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,fold,(Sequence,State,ForwardOp))
};

CPPCMS_BOOST_MPL_AUX_NA_SPEC(3, fold)
