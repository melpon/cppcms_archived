...
#ifndef CPPCMS_BOOST_MPL_NEGATE_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_NEGATE_HPP_INCLUDED
...
#endif
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1, negate, (N))
};

CPPCMS_BOOST_MPL_AUX_NA_SPEC(1, negate)
...
{
    CPPCMS_BOOST_STATIC_CONSTANT(T, value = -n);
