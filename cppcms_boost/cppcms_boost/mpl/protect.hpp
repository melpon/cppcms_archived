...
#ifndef CPPCMS_BOOST_MPL_PROTECT_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_PROTECT_HPP_INCLUDED
...
namespace aux { 
template< CPPCMS_BOOST_MPL_AUX_NTTP_DECL(int, N), typename T >
...
CPPCMS_BOOST_MPL_AUX_NA_SPEC_MAIN(1, protect)
#if !defined(CPPCMS_BOOST_MPL_CFG_NO_FULL_LAMBDA_SUPPORT)
CPPCMS_BOOST_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(1, 1, protect)
#endif
