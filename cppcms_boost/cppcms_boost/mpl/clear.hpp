...
#ifndef CPPCMS_BOOST_MPL_CLEAR_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_CLEAR_HPP_INCLUDED
...
#include <cppcms_boost/mpl/clear_fwd.hpp>
#include <cppcms_boost/mpl/aux_/clear_impl.hpp>
...
{
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,clear,(Sequence))
};

CPPCMS_BOOST_MPL_AUX_NA_SPEC(1, clear)
