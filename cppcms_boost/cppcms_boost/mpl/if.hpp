...
#ifndef CPPCMS_BOOST_MPL_IF_HPP_INCLUDED
#define CPPCMS_BOOST_MPL_IF_HPP_INCLUDED
...
template<
    ...
    , typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(T3)
    >
struct if_
{
 private:
    ...
    typedef if_c<
          ...
          CPPCMS_BOOST_MPL_AUX_VALUE_WKND(T1)::value
#else
          CPPCMS_BOOST_MPL_AUX_STATIC_CAST(bool, CPPCMS_BOOST_MPL_AUX_VALUE_WKND(T1)::value)
#endif
        , T2
        , T3
        > almost_type_;
 ...
 public:
    ...
    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(T1,T2,T3))
};
...
template<
      typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(C_)
    , typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(T1)
    , typename CPPCMS_BOOST_MPL_AUX_NA_PARAM(T2)
    >
struct if_
{
    enum { msvc_wknd_ = CPPCMS_BOOST_MPL_AUX_MSVC_VALUE_WKND(C_)::value };

    typedef typename aux::if_impl< CPPCMS_BOOST_MPL_AUX_STATIC_CAST(bool, msvc_wknd_) >
        ::template result_<T1,T2>::type type;

    CPPCMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(C_,T1,T2))
};

#endif // BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION

CPPCMS_BOOST_MPL_AUX_NA_SPEC(3, if_)
