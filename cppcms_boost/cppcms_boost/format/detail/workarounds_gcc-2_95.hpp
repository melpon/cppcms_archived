...
#ifndef CPPCMS_BOOST_FORMAT_WORKAROUNDS_GCC295_H
#define CPPCMS_BOOST_FORMAT_WORKAROUNDS_GCC295_H

// SGI STL doesnt have <ostream> and others, so we need iostream.
#include <iostream> 
#define CPPCMS_BOOST_FORMAT_OSTREAM_DEFINED

#include <streambuf.h>
#define CPPCMS_BOOST_FORMAT_STREAMBUF_DEFINED

#define CPPCMS_BOOST_NO_TEMPLATE_STD_STREAM
