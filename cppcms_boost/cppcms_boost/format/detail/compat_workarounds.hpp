...
#ifndef CPPCMS_BOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
#define CPPCMS_BOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
...
#include <cppcms_boost/format/detail/config_macros.hpp>
   // sets-up macros and load compiler-specific workarounds headers.

#if !defined(CPPCMS_BOOST_FORMAT_STREAMBUF_DEFINED)
// workarounds-gcc-2.95 might have defined own streambuf
#include <streambuf>
#endif

#if !defined(CPPCMS_BOOST_FORMAT_OSTREAM_DEFINED)
