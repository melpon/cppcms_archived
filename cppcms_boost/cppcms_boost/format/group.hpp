...
#ifndef CPPCMS_BOOST_FORMAT_GROUP_HPP
#define CPPCMS_BOOST_FORMAT_GROUP_HPP
...
inline
CPPCMS_BOOST_IO_STD basic_ostream<Ch, Tr>&
operator << ( CPPCMS_BOOST_IO_STD basic_ostream<Ch, Tr>& os,
             const group0& )
{ 
   return os; 
}
