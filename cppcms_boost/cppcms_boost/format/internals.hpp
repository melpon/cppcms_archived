...
#ifndef CPPCMS_BOOST_FORMAT_INTERNALS_HPP
#define CPPCMS_BOOST_FORMAT_INTERNALS_HPP


#include <string>
#include <cppcms_boost/assert.hpp>
#include <cppcms_boost/optional.hpp>
#include <cppcms_boost/limits.hpp>
#include <cppcms_boost/format/detail/compat_workarounds.hpp>
#include <cppcms_boost/format/alt_sstream.hpp> // used as a dummy stream
...
//   set of params that define the format state of a stream
    ...
    {
        typedef CPPCMS_BOOST_IO_STD basic_ios<Ch, Tr>   basic_ios;
...
//        stream_format_state(const basic_ios& os)     { set_by_stream(os); }
        ...
        void apply_on(basic_ios & os,            //- applies format_state to the stream
                      cppcms_boost::io::detail::locale_t * loc_default = 0) const;
        template<class T> 
        ...
        cppcms_boost::optional<cppcms_boost::io::detail::locale_t>  loc_;
    };  
...
// -   stream_format_state:: -------------------------------------------------
    ...
    void stream_format_state<Ch,Tr>:: apply_on (basic_ios & os,
                      cppcms_boost::io::detail::locale_t * loc_default) const {
    ...
    compute_states() {
        ...
        if(pad_scheme_ & zeropad) {
            ...
            if(fmtstate_.flags_ & std::ios_base::left) {
              CPPCMS_BOOST_ASSERT(!(fmtstate_.flags_ &(std::ios_base::adjustfield ^std::ios_base::left)));
