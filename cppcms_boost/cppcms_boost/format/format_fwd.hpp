...
#ifndef CPPCMS_BOOST_FORMAT_FWD_HPP
#define CPPCMS_BOOST_FORMAT_FWD_HPP
...
namespace cppcms_boost {
    ...
    // gcc-2.95's native  stdlid needs special treatment
        class Tr = CPPCMS_BOOST_IO_STD char_traits<Ch>, class Alloc = std::allocator<Ch> > 
#else
...
#if !defined(CPPCMS_BOOST_NO_STD_WSTRING)  && !defined(CPPCMS_BOOST_NO_STD_WSTREAMBUF) \
    && !defined(CPPCMS_BOOST_FORMAT_IGNORE_STRINGSTREAM)
