...
#ifndef CPPCMS_BOOST_FORMAT_CLASS_HPP
#define CPPCMS_BOOST_FORMAT_CLASS_HPP


#include <vector>
#include <string>

#include <cppcms_boost/optional.hpp> // to store locale when needed

#include <cppcms_boost/format/format_fwd.hpp>
#include <cppcms_boost/format/internals_fwd.hpp>
#include <cppcms_boost/format/internals.hpp>
#include <cppcms_boost/format/alt_sstream.hpp>
...
namespace cppcms_boost {
    ...
    && !CPPCMS_BOOST_WORKAROUND(__BORLANDC__, <= 0x570) \
    && !CPPCMS_BOOST_WORKAROUND( _CRAYC, != 0) \
...
#ifndef  CPPCMS_BOOST_NO_TEMPLATE_STD_STREAM
    ...
    private:
        ...
        cppcms_boost::optional<io::detail::locale_t>     loc_;
    }; // class basic_format
