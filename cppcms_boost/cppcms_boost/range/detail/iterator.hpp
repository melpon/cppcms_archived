...
#ifndef CPPCMS_BOOST_RANGE_DETAIL_ITERATOR_HPP
#define CPPCMS_BOOST_RANGE_DETAIL_ITERATOR_HPP
...
namespace cppcms_boost 
{
    ...
    {        
        ...
        struct range_iterator_<std_container_>
        {
            ...
            struct pts
            {
                typedef CPPCMS_BOOST_RANGE_DEDUCED_TYPENAME C::iterator type;
            };
        };
    ...
    {
        typedef CPPCMS_BOOST_RANGE_DEDUCED_TYPENAME range_detail::range<C>::type c_type;
    public:
        typedef typename range_detail::range_iterator_<c_type>::CPPCMS_BOOST_NESTED_TEMPLATE pts<C>::type type; 
    };
}
