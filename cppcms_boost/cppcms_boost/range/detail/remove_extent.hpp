...
#ifndef CPPCMS_BOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP
#define CPPCMS_BOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP

#include <cppcms_boost/config.hpp>  // MSVC, NO_INTRINSIC_WCHAR_T, put size_t in std.
#include <cstddef>
...
namespace cppcms_boost 
{
    namespace range_detail
    {
        ...
        struct remove_extent {
            static T* ar;
            CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, size = sizeof(*ar) / sizeof((*ar)[0]));
