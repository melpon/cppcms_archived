...
#ifndef CPPCMS_BOOST_RANGE_END_HPP
#define CPPCMS_BOOST_RANGE_END_HPP
...
#include <cppcms_boost/range/detail/end.hpp>
#else
...
template< class T >
inline CPPCMS_BOOST_DEDUCED_TYPENAME range_iterator<T>::type end( T& r )
{
#if !CPPCMS_BOOST_WORKAROUND(__BORLANDC__, CPPCMS_BOOST_TESTED_AT(0x564)) && \
    !CPPCMS_BOOST_WORKAROUND(__GNUC__, < 3) \
    /**/
...
template< class T >
inline CPPCMS_BOOST_DEDUCED_TYPENAME range_iterator<const T>::type end( const T& r )
{
#if !CPPCMS_BOOST_WORKAROUND(__BORLANDC__, CPPCMS_BOOST_TESTED_AT(0x564)) && \
    !CPPCMS_BOOST_WORKAROUND(__GNUC__, < 3) \
    /**/
