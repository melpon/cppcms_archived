...
#if !defined(CPPCMS_BOOST_FUNCTIONAL_HASH_EXTENSIONS_HPP)
#define CPPCMS_BOOST_FUNCTIONAL_HASH_EXTENSIONS_HPP

#include <cppcms_boost/functional/hash/hash.hpp>
#include <cppcms_boost/detail/container_fwd.hpp>
...
namespace cppcms_boost
{
    ...
    namespace hash_detail
    {
        ...
        struct call_hash_impl<true>
        {
            ...
            struct inner
            {
...
#endif
                {
                    ...
                    return cppcms_boost::hash_range(v, v + size);
                }
            };
        };
        ...
        template <class T>
        struct call_hash
            : public call_hash_impl<cppcms_boost::is_array<T>::value>
        ...
        : std::unary_function<T[n], std::size_t>
    {
        ...
        {
            return cppcms_boost::hash_range(val, val+n);
        }
    };
#endif
    ...
    namespace hash_detail
    {
        ...
        struct hash_impl_msvc2
            : public hash_impl_msvc<cppcms_boost::is_const<T>::value>
                    ::CPPCMS_BOOST_NESTED_TEMPLATE inner<T> {};
