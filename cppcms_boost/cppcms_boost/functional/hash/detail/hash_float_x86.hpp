...
#if !defined(CPPCMS_BOOST_FUNCTIONAL_HASH_DETAIL_HASH_FLOAT_X86_HEADER)
#define CPPCMS_BOOST_FUNCTIONAL_HASH_DETAIL_HASH_FLOAT_X86_HEADER
...
namespace cppcms_boost
{
    namespace hash_detail
    {
        ...
        {
            cppcms_boost::uint32_t* ptr = (cppcms_boost::uint32_t*)&v;
            std::size_t seed = *ptr;
            return seed;
        }
        ...
        inline std::size_t float_hash_impl(long double v)
        {
            ...
            std::size_t seed = *ptr++;
            hash_float_combine(seed, *ptr++);
            hash_float_combine(seed, *(cppcms_boost::uint16_t*)ptr);
            return seed;
        }
    }
}
