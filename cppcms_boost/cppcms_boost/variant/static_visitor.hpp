...
#ifndef CPPCMS_BOOST_VARIANT_STATIC_VISITOR_HPP
#define CPPCMS_BOOST_VARIANT_STATIC_VISITOR_HPP
...
template <typename R = ::cppcms_boost::detail::static_visitor_default_return>
...
struct is_static_visitor_impl
{
    CPPCMS_BOOST_STATIC_CONSTANT(bool, value = 
        (::cppcms_boost::is_base_and_derived< 
...
CPPCMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(
      is_static_visitor
    , T
    , (::cppcms_boost::detail::is_static_visitor_impl<T>::value)
    )
