...
#ifndef CPPCMS_BOOST_VARIANT_DETAIL_ENABLE_RECURSIVE_HPP
#define CPPCMS_BOOST_VARIANT_DETAIL_ENABLE_RECURSIVE_HPP
...
#include "cppcms_boost/variant/detail/substitute.hpp"
#include "cppcms_boost/mpl/aux_/config/ctps.hpp"
#include "cppcms_boost/mpl/bool_fwd.hpp"
...
#include "cppcms_boost/variant/recursive_wrapper.hpp"
...
#   define CPPCMS_BOOST_VARIANT_AUX_ENABLE_RECURSIVE_IMPL(T,Dest,Source) \
...
struct enable_recursive
    : CPPCMS_BOOST_VARIANT_AUX_ENABLE_RECURSIVE_IMPL(
          T, RecursiveVariant, ::cppcms_boost::recursive_variant_
        )
{
};
...
private: // helpers, for metafunction result (below)
    ...
    typedef typename CPPCMS_BOOST_VARIANT_AUX_ENABLE_RECURSIVE_IMPL(
          T, RecursiveVariant, ::cppcms_boost::recursive_variant_
        )::type t_;
...
public: // metafunction result
    ...
    typedef typename mpl::if_<
          mpl::or_<
            ...
            >
        , t_
        , cppcms_boost::recursive_wrapper<t_>
        >::type type;
