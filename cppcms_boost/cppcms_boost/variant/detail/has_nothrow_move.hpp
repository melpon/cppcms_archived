...
#ifndef CPPCMS_BOOST_VARIANT_DETAIL_HAS_NOTHROW_MOVE_HPP_INCLUDED
#define CPPCMS_BOOST_VARIANT_DETAIL_HAS_NOTHROW_MOVE_HPP_INCLUDED

#include "cppcms_boost/config.hpp" // for STATIC_CONSTANT
#include "cppcms_boost/variant/detail/has_trivial_move.hpp"
...
CPPCMS_BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
      has_nothrow_move
    , T
    , (::cppcms_boost::detail::variant::has_nothrow_move_impl<T>::value)
    )
...
CPPCMS_BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , (::cppcms_boost::detail::variant::has_nothrow_move_constructor_impl<T>::value)
    )
...
CPPCMS_BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , (::cppcms_boost::detail::variant::has_nothrow_move_assign_impl<T>::value)
    )

}} // namespace detail::variant

CPPCMS_BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::cppcms_boost::detail::variant::has_nothrow_move)
CPPCMS_BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::cppcms_boost::detail::variant::has_nothrow_move_constructor)
CPPCMS_BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::cppcms_boost::detail::variant::has_nothrow_move_assign)
