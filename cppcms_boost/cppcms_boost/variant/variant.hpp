...
#ifndef CPPCMS_BOOST_VARIANT_VARIANT_HPP
#define CPPCMS_BOOST_VARIANT_VARIANT_HPP

#include <cstddef> // for std::size_t
#include <new> // for placement new

#if !defined(CPPCMS_BOOST_NO_TYPEID)
#include <typeinfo> // for typeid, std::type_info
#endif // BOOST_NO_TYPEID

#include "cppcms_boost/variant/detail/config.hpp"
...
#include "cppcms_boost/type_traits/alignment_of.hpp"
#include "cppcms_boost/type_traits/add_const.hpp"
...
#include "cppcms_boost/mpl/empty.hpp"
#include "cppcms_boost/mpl/find_if.hpp"
#include "cppcms_boost/mpl/front.hpp"
...
#include "cppcms_boost/mpl/max_element.hpp"
...
#include "cppcms_boost/mpl/same_as.hpp"
#include "cppcms_boost/mpl/size_t.hpp"
#include "cppcms_boost/mpl/sizeof.hpp"
...
#if defined(CPPCMS_BOOST_VARIANT_MINIMIZE_SIZE)
#   include <climits> // for SCHAR_MAX
#   include "cppcms_boost/mpl/eval_if.hpp"
#   include "cppcms_boost/mpl/equal_to.hpp"
#   include "cppcms_boost/mpl/identity.hpp"
#   include "cppcms_boost/mpl/int.hpp"
#   include "cppcms_boost/mpl/if.hpp"
...
private: // helpers, for metafunction result (below)
    ...
    typedef typename mpl::iter_fold_if<
        ...
        , mpl::protect< mpl::not_same_as<cppcms_boost::blank> >
        >::type second_result_;
...
public: // metafunction result
    ...
    typedef ::cppcms_boost::aligned_storage<
          CPPCMS_BOOST_MPL_AUX_VALUE_WKND(max_size)::value
        , CPPCMS_BOOST_MPL_AUX_VALUE_WKND(max_alignment)::value
        > type;

#else // MSVC7 and below

    CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, msvc_max_size_c = max_size::value);
    CPPCMS_BOOST_STATIC_CONSTANT(std::size_t, msvc_max_alignment_c = max_alignment::value);
...
public: // visitor interfaces
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(T& operand, int) const
    {
        operand.~T();

#if CPPCMS_BOOST_WORKAROUND(__BORLANDC__, CPPCMS_BOOST_TESTED_AT(0x0551)) || \
    CPPCMS_BOOST_WORKAROUND(CPPCMS_BOOST_MSVC, CPPCMS_BOOST_TESTED_AT(1600))
        operand; // suppresses warnings
#endif

        CPPCMS_BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::cppcms_boost::detail::variant::forced_return< T& >();
    }
...
public: // internal visitor interface
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(cppcms_boost::detail::variant::backup_holder<T>& operand, long) const
    {
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(const cppcms_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
        CPPCMS_BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
#if CPPCMS_BOOST_WORKAROUND(CPPCMS_BOOST_MSVC, CPPCMS_BOOST_TESTED_AT(1600))
private:
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::cppcms_boost::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        catch (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::cppcms_boost::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::cppcms_boost::detail::variant::move_swap( operand, other );
    }
...
#   if CPPCMS_BOOST_WORKAROUND(__BORLANDC__, CPPCMS_BOOST_TESTED_AT(0x0564))
    template <typename T>
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(cppcms_boost::recursive_wrapper<T>& operand, long)
    {
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const cppcms_boost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(cppcms_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const cppcms_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(cppcms_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        CPPCMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const cppcms_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
template <
      typename T0_
    , CPPCMS_BOOST_VARIANT_ENUM_SHIFTED_PARAMS(typename T)
    >
class variant
{
...
private: // helpers, for typedefs (below)
    ...
    CPPCMS_BOOST_STATIC_ASSERT((
          ::cppcms_boost::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
private: // helpers, for typedefs (below)
    ...
    #define CPPCMS_BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS(z,N,_) \
        typedef typename mpl::eval_if< \
            ...
            , detail::variant::enable_recursive< \
                ...
                , wknd_self_t \
                > \
            , mpl::identity< CPPCMS_BOOST_PP_CAT(T,N) > \
            >::type CPPCMS_BOOST_PP_CAT(recursive_enabled_T,N); \
        /**/
    ...
    #define CPPCMS_BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS(z,N,_) \
    ...
    CPPCMS_BOOST_PP_REPEAT(
          CPPCMS_BOOST_VARIANT_LIMIT_TYPES
        , CPPCMS_BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS
        , _
        )

    #undef CPPCMS_BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS

public: // public typedefs

    typedef typename detail::variant::make_variant_list<
          CPPCMS_BOOST_VARIANT_ENUM_PARAMS(public_T)
        >::type types;

private: // helpers, for internal typedefs (below)

    #define CPPCMS_BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS(z,N,_) \
        typedef detail::make_reference_content< \
              CPPCMS_BOOST_PP_CAT(recursive_enabled_T,N) \
            >::type CPPCMS_BOOST_PP_CAT(internal_T,N); \
        /**/

    CPPCMS_BOOST_PP_REPEAT(
          CPPCMS_BOOST_VARIANT_LIMIT_TYPES
        , CPPCMS_BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS
        , _
        )

    #undef CPPCMS_BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS

private: // internal typedefs

    typedef typename detail::variant::make_variant_list<
          CPPCMS_BOOST_VARIANT_ENUM_PARAMS(internal_T)
        >::type internal_types;
...
private: // static precondition assertions
    ...
    //
    CPPCMS_BOOST_MPL_ASSERT_NOT(( is_sequence_based_ ));
...
#if !defined(CPPCMS_BOOST_NO_MEMBER_TEMPLATE_FRIENDS)
    private:
#else
    public:
#endif
...
private: // helpers, for structors (below)
    ...
    struct initializer
        : CPPCMS_BOOST_VARIANT_AUX_INITIALIZER_T(
...
#   endif
        ...
        template <typename T>
        int internal_visit(cppcms_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const cppcms_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(cppcms_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const cppcms_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(cppcms_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const cppcms_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below 
    ...
    template <CPPCMS_BOOST_VARIANT_ENUM_PARAMS(typename U)>
    void convert_construct(
          cppcms_boost::variant<CPPCMS_BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    template <CPPCMS_BOOST_VARIANT_ENUM_PARAMS(typename U)>
    void convert_construct(
          const cppcms_boost::variant<CPPCMS_BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);    
...
#if !defined(CPPCMS_BOOST_VARIANT_AUX_BROKEN_CONSTRUCTOR_TEMPLATE_ORDERING)
...
#elif defined(CPPCMS_BOOST_VARIANT_AUX_HAS_CONSTRUCTOR_TEMPLATE_ORDERING_SFINAE_WKND)
    ...
    private: // helpers, for internal visitor interface (below)
            ...
            )
        {
            ...
            catch (...)
            {
                ...
                lhs_.indicate_which(
                      CPPCMS_BOOST_MPL_AUX_VALUE_WKND(fallback_type_index_)::value
                    ); // nothrow
...
#   define CPPCMS_BOOST_VARIANT_AUX_FAIL_COMPARISON_RETURN_TYPE \
    void
...
#   define CPPCMS_BOOST_VARIANT_AUX_FAIL_COMPARISON_RETURN_TYPE \
    ...
    template <typename U>
        CPPCMS_BOOST_VARIANT_AUX_FAIL_COMPARISON_RETURN_TYPE
    operator==(const U&) const
    {
        CPPCMS_BOOST_STATIC_ASSERT( false && sizeof(U) );
    }
...
inline void swap(
      variant< CPPCMS_BOOST_VARIANT_ENUM_PARAMS(T) >& lhs
    , variant< CPPCMS_BOOST_VARIANT_ENUM_PARAMS(T) >& rhs
    )
{
    lhs.swap(rhs);
}
...
#include "cppcms_boost/variant/detail/variant_io.hpp"
