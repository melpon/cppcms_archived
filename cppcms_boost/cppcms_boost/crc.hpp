...
#ifndef CPPCMS_BOOST_CRC_HPP
#define CPPCMS_BOOST_CRC_HPP

#include <cppcms_boost/config.hpp>   // for BOOST_STATIC_CONSTANT, etc.
#include <cppcms_boost/integer.hpp>  // for boost::uint_t

#include <climits>  // for CHAR_BIT, etc.
#include <cstddef>  // for std::size_t

#include <cppcms_boost/limits.hpp>  // for std::numeric_limits
...
#if !(defined(CPPCMS_BOOST_NO_DEPENDENT_TYPES_IN_TEMPLATE_VALUE_PARAMETERS) || (defined(CPPCMS_BOOST_MSVC) && (CPPCMS_BOOST_MSVC <= 1300)))
#define CPPCMS_BOOST_CRC_PARM_TYPE  typename ::cppcms_boost::uint_t<Bits>::fast
#else
#define CPPCMS_BOOST_CRC_PARM_TYPE  unsigned long
#endif
...
#if defined(__GNUC__) || !defined(CPPCMS_BOOST_NO_EXPLICIT_FUNCTION_TEMPLATE_ARGUMENTS)
#define CPPCMS_BOOST_CRC_DUMMY_PARM_TYPE
#define CPPCMS_BOOST_CRC_DUMMY_INIT
#define CPPCMS_BOOST_ACRC_DUMMY_PARM_TYPE
#define CPPCMS_BOOST_ACRC_DUMMY_INIT
#else
namespace cppcms_boost { namespace detail {
    template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly,
     CPPCMS_BOOST_CRC_PARM_TYPE InitRem, CPPCMS_BOOST_CRC_PARM_TYPE FinalXor,
     bool ReflectIn, bool ReflectRem >
    struct dummy_crc_argument  { };
} }
#define CPPCMS_BOOST_CRC_DUMMY_PARM_TYPE   , detail::dummy_crc_argument<Bits, \
 TruncPoly, InitRem, FinalXor, ReflectIn, ReflectRem> *p_
#define CPPCMS_BOOST_CRC_DUMMY_INIT        CPPCMS_BOOST_CRC_DUMMY_PARM_TYPE = 0
#define CPPCMS_BOOST_ACRC_DUMMY_PARM_TYPE  , detail::dummy_crc_argument<Bits, \
 TruncPoly, 0, 0, false, false> *p_
#define CPPCMS_BOOST_ACRC_DUMMY_INIT       CPPCMS_BOOST_ACRC_DUMMY_PARM_TYPE = 0
#endif
...
template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly = 0u,
           CPPCMS_BOOST_CRC_PARM_TYPE InitRem = 0u,
           CPPCMS_BOOST_CRC_PARM_TYPE FinalXor = 0u, bool ReflectIn = false,
...
template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly,
    ...
    typename uint_t<Bits>::fast  crc( void const *buffer,
     ...
     CPPCMS_BOOST_CRC_DUMMY_PARM_TYPE );
...
template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly >
    typename uint_t<Bits>::fast  augmented_crc( void const *buffer,
     ...
     CPPCMS_BOOST_ACRC_DUMMY_PARM_TYPE );
...
namespace detail
{
    ...
    template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly, bool Reflect >
        struct crc_table_t;
...
public:
    ...
    CPPCMS_BOOST_STATIC_CONSTANT( std::size_t, bit_count = Bits );
...
public:
    ...
    CPPCMS_BOOST_STATIC_CONSTANT( std::size_t, bit_count = Bits );
    CPPCMS_BOOST_STATIC_CONSTANT( value_type, truncated_polynominal = TruncPoly );
    CPPCMS_BOOST_STATIC_CONSTANT( value_type, initial_remainder = InitRem );
    CPPCMS_BOOST_STATIC_CONSTANT( value_type, final_xor_value = FinalXor );
    CPPCMS_BOOST_STATIC_CONSTANT( bool, reflect_input = ReflectIn );
    CPPCMS_BOOST_STATIC_CONSTANT( bool, reflect_remainder = ReflectRem );
...
private:
    ...
    CPPCMS_BOOST_STATIC_CONSTANT( bool, reflect_output = (ReflectRem != ReflectIn) );

    #ifndef __BORLANDC__
    #define CPPCMS_BOOST_CRC_REF_OUT_VAL  reflect_output
    #else
    typedef crc_optimal  self_type;
    #define CPPCMS_BOOST_CRC_REF_OUT_VAL  (self_type::reflect_output)
    #endif
    ...
    typedef detail::crc_helper<Bits, CPPCMS_BOOST_CRC_REF_OUT_VAL>  reflect_out_type;

    #undef CPPCMS_BOOST_CRC_REF_OUT_VAL
...
namespace detail
{
    ...
    template < std::size_t Bits >
    struct high_uint_t
        : cppcms_boost::uint_t< Bits >
    {
        typedef cppcms_boost::uint_t<Bits>        base_type;
...
#else
        CPPCMS_BOOST_STATIC_CONSTANT( least, high_bit = (least( 1u ) << ( Bits
         - 1u )) );
        CPPCMS_BOOST_STATIC_CONSTANT( fast, high_bit_fast = (fast( 1u ) << ( Bits
         - 1u )) );
#endif
    ...
    struct reflector
    {
        typedef typename cppcms_boost::uint_t<Bits>::fast  value_type;
        ...
        : high_uint_t< Bits >
    {
        ...
        #else
        CPPCMS_BOOST_STATIC_CONSTANT( least, high_bit = base_type::high_bit );
        CPPCMS_BOOST_STATIC_CONSTANT( fast, high_bit_fast = base_type::high_bit_fast );
        #endif

#if defined(__EDG_VERSION__) && __EDG_VERSION__ <= 243
        static const least sig_bits = (~( ~( 0ul ) << Bits )) ;
#else
        CPPCMS_BOOST_STATIC_CONSTANT( least, sig_bits = (~( ~(least( 0u )) << Bits )) );
#endif
#if defined(__GNUC__) && __GNUC__ == 4 && __GNUC_MINOR__ == 0 && __GNUC_PATCHLEVEL__ == 2
        // Work around a weird bug that ICEs the compiler in build_c_cast
        CPPCMS_BOOST_STATIC_CONSTANT( fast, sig_bits_fast = static_cast<fast>(sig_bits) );
#else
        CPPCMS_BOOST_STATIC_CONSTANT( fast, sig_bits_fast = fast(sig_bits) );
#endif
        ...
        : high_uint_t< std::numeric_limits<unsigned char>::digits >
    {
        ...
        CPPCMS_BOOST_STATIC_CONSTANT( least, sig_bits = (~( least(0u) )) );
        CPPCMS_BOOST_STATIC_CONSTANT( fast, sig_bits_fast = fast(sig_bits) );
    ...
    struct crc_table_t
    {
        CPPCMS_BOOST_STATIC_CONSTANT( std::size_t, byte_combos = (1ul << CHAR_BIT) );
...
#define CPPCMS_BOOST_CRC_OPTIMAL_NAME  crc_optimal<Bits, TruncPoly, InitRem, \
...
template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly,
           ...
           bool ReflectIn, bool ReflectRem >
inline
CPPCMS_BOOST_CRC_OPTIMAL_NAME::crc_optimal
(
    typename CPPCMS_BOOST_CRC_OPTIMAL_NAME::value_type  init_rem  // = InitRem
)
...
template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly,
           ...
           bool ReflectIn, bool ReflectRem >
inline
typename CPPCMS_BOOST_CRC_OPTIMAL_NAME::value_type
CPPCMS_BOOST_CRC_OPTIMAL_NAME::get_truncated_polynominal
(
) const
{
    return TruncPoly;
...
inline
typename CPPCMS_BOOST_CRC_OPTIMAL_NAME::value_type
CPPCMS_BOOST_CRC_OPTIMAL_NAME::get_initial_remainder
(
) const
{
    return InitRem;
...
inline
typename CPPCMS_BOOST_CRC_OPTIMAL_NAME::value_type
CPPCMS_BOOST_CRC_OPTIMAL_NAME::get_final_xor_value
(
) const
{
    return FinalXor;
...
inline
bool
CPPCMS_BOOST_CRC_OPTIMAL_NAME::get_reflect_input
(
) const
{
    return ReflectIn;
...
inline
bool
CPPCMS_BOOST_CRC_OPTIMAL_NAME::get_reflect_remainder
(
) const
{
    return ReflectRem;
...
inline
typename CPPCMS_BOOST_CRC_OPTIMAL_NAME::value_type
CPPCMS_BOOST_CRC_OPTIMAL_NAME::get_interim_remainder
(
) const
{
...
inline
void
CPPCMS_BOOST_CRC_OPTIMAL_NAME::reset
(
    typename CPPCMS_BOOST_CRC_OPTIMAL_NAME::value_type  new_rem  // = InitRem
)
{
...
inline
void
CPPCMS_BOOST_CRC_OPTIMAL_NAME::process_byte
(
    unsigned char  byte
)
{
...
template < std::size_t Bits, CPPCMS_BOOST_CRC_PARM_TYPE TruncPoly,
           ...
           bool ReflectIn, bool ReflectRem >
void
CPPCMS_BOOST_CRC_OPTIMAL_NAME::process_block
(
    void const *  bytes_begin,
    void const *  bytes_end
)
...
inline
void
CPPCMS_BOOST_CRC_OPTIMAL_NAME::process_bytes
(
    void const *   buffer,
    std::size_t  byte_count
)
...
inline
typename CPPCMS_BOOST_CRC_OPTIMAL_NAME::value_type
CPPCMS_BOOST_CRC_OPTIMAL_NAME::checksum
(
) const
{
...
inline
void
CPPCMS_BOOST_CRC_OPTIMAL_NAME::operator ()
(
    unsigned char  byte
)
{
...
(
    void const *  buffer,
    std::size_t   byte_count
    CPPCMS_BOOST_CRC_DUMMY_INIT
)
{
    CPPCMS_BOOST_CRC_OPTIMAL_NAME  computer;
...
#undef CPPCMS_BOOST_CRC_OPTIMAL_NAME
#undef CPPCMS_BOOST_ACRC_DUMMY_INIT
#undef CPPCMS_BOOST_ACRC_DUMMY_PARM_TYPE
#undef CPPCMS_BOOST_CRC_DUMMY_INIT
#undef CPPCMS_BOOST_CRC_DUMMY_PARM_TYPE
#undef CPPCMS_BOOST_CRC_PARM_TYPE
