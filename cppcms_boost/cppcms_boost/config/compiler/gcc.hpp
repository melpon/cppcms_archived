...
#  define CPPCMS_BOOST_HAS_VARIADIC_TMPL
#else
...
#  define CPPCMS_BOOST_HAS_CONCEPTS
#  define CPPCMS_BOOST_COMPILER "ConceptGCC version " __VERSION__
#else
#  define CPPCMS_BOOST_NO_CONCEPTS
#endif

#ifndef CPPCMS_BOOST_COMPILER
#  define CPPCMS_BOOST_COMPILER "GNU C++ version " __VERSION__
#endif
