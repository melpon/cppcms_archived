...
#define CPPCMS_BOOST_PLATFORM "Mac OS"
...
#  ifndef CPPCMS_BOOST_HAS_STDINT_H
...
#  if !defined(CPPCMS_BOOST_HAS_PTHREADS)
#    define CPPCMS_BOOST_HAS_MPTASKS
...
#    define CPPCMS_BOOST_BIND_ENABLE_PASCAL
