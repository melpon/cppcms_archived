...
#ifdef __FreeBSD__
#define CPPCMS_BOOST_PLATFORM "FreeBSD " CPPCMS_BOOST_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define CPPCMS_BOOST_PLATFORM "NetBSD " CPPCMS_BOOST_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define CPPCMS_BOOST_PLATFORM "OpenBSD " CPPCMS_BOOST_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define CPPCMS_BOOST_PLATFORM "DragonFly " CPPCMS_BOOST_STRINGIZE(__DragonFly__)
#endif
...
#  define CPPCMS_BOOST_NO_CTYPE_FUNCTIONS
#endif
