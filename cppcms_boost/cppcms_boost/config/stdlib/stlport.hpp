...
#  if !(_STLPORT_VERSION >= 0x500) && !defined(_STLP_OWN_IOSTREAMS) && defined(_STLP_USE_NAMESPACES) && defined(CPPCMS_BOOST_NO_USING_TEMPLATE) && !defined(__BORLANDC__)
#     define CPPCMS_BOOST_NO_STD_LOCALE
#  endif
#else
#  if !defined(__SGI_STL_OWN_IOSTREAMS) && defined(__STL_USE_NAMESPACES) && defined(CPPCMS_BOOST_NO_USING_TEMPLATE) && !defined(__BORLANDC__)
#     define CPPCMS_BOOST_NO_STD_LOCALE
#  endif
#endif

#if defined(_STLPORT_VERSION) && ((_STLPORT_VERSION < 0x500) || (_STLPORT_VERSION >= 0x520))
#  define CPPCMS_BOOST_NO_STD_UNORDERED
#endif
...
#if defined(_STLP_NO_MEMBER_TEMPLATE_KEYWORD) && defined(CPPCMS_BOOST_MSVC) && (CPPCMS_BOOST_MSVC <= 1300)
#  define CPPCMS_BOOST_NO_STD_ALLOCATOR
#endif
...
#     define CPPCMS_BOOST_NO_STD_WSTRING
#  endif
#  ifndef  CPPCMS_BOOST_NO_STD_WSTREAMBUF
...
#  define CPPCMS_BOOST_HAS_STLP_USE_FACET
#endif
...
// into std:: ourselves).
//
#if defined(_STLP_NO_NATIVE_WIDE_FUNCTIONS) && !defined(CPPCMS_BOOST_NO_STDC_NAMESPACE)
...
//
#if !defined( _STLP_HAS_WCHAR_T) || defined(_STLP_WCHAR_T_IS_USHORT)
#  undef  CPPCMS_BOOST_NO_INTRINSIC_WCHAR_T
...
#  define CPPCMS_BOOST_USING_STD_MIN() ((void)0)
#  define CPPCMS_BOOST_USING_STD_MAX() ((void)0)
namespace cppcms_boost { using std::min; using std::max; }
#endif
...
#define CPPCMS_BOOST_STDLIB "STLPort standard library version " CPPCMS_BOOST_STRINGIZE(__SGI_STL_PORT)
