...
#ifdef __GLIBCXX__
#define CPPCMS_BOOST_STDLIB "GNU libstdc++ version " CPPCMS_BOOST_STRINGIZE(__GLIBCXX__)
#else
#define CPPCMS_BOOST_STDLIB "GNU libstdc++ version " CPPCMS_BOOST_STRINGIZE(__GLIBCPP__)
#endif
...
#  define CPPCMS_BOOST_HAS_THREADS
    ...
    && defined(CPPCMS_BOOST_HAS_LONG_LONG)
...
#  define CPPCMS_BOOST_STD_EXTENSION_NAMESPACE __gnu_cxx
#  define CPPCMS_BOOST_HAS_SLIST
#  define CPPCMS_BOOST_HAS_HASH
#  define CPPCMS_BOOST_SLIST_HEADER <ext/slist>
# if !defined(__GNUC__) || __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 3)
#   define CPPCMS_BOOST_HASH_SET_HEADER <ext/hash_set>
#   define CPPCMS_BOOST_HASH_MAP_HEADER <ext/hash_map>
# else
#   define CPPCMS_BOOST_HASH_SET_HEADER <backward/hash_set>
#   define CPPCMS_BOOST_HASH_MAP_HEADER <backward/hash_map>
# endif
#endif
