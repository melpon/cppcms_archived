...
//
#ifndef _RWSTD_VER
#  define CPPCMS_BOOST_RWSTD_VER 0x010000
#elif _RWSTD_VER < 0x010000
#  define CPPCMS_BOOST_RWSTD_VER (_RWSTD_VER << 8)
#else
#  define CPPCMS_BOOST_RWSTD_VER _RWSTD_VER
#endif

#ifndef _RWSTD_VER
#  define CPPCMS_BOOST_STDLIB "Rogue Wave standard library version (Unknown version)"
#elif _RWSTD_VER < 0x04010200
 #  define CPPCMS_BOOST_STDLIB "Rogue Wave standard library version " CPPCMS_BOOST_STRINGIZE(_RWSTD_VER)
#else
#  ifdef _RWSTD_VER_STR
#    define CPPCMS_BOOST_STDLIB "Apache STDCXX standard library version " _RWSTD_VER_STR
#  else
#    define CPPCMS_BOOST_STDLIB "Apache STDCXX standard library version " CPPCMS_BOOST_STRINGIZE(_RWSTD_VER)
#  endif
#endif
...
// template do:
//
#if CPPCMS_BOOST_RWSTD_VER < 0x020200
#  define CPPCMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
#endif

// Sun CC 5.5 patch 113817-07 adds long long specialization, but does not change the
// library version number (http://sunsolve6.sun.com/search/document.do?assetkey=1-21-113817):
#if CPPCMS_BOOST_RWSTD_VER <= 0x020101 && (!defined(__SUNPRO_CC) || (__SUNPRO_CC < 0x550))
...
//
#if defined(_RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || defined(RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || (CPPCMS_BOOST_RWSTD_VER < 0x020000)
...
//
#if (CPPCMS_BOOST_RWSTD_VER < 0x020000)
#  define CPPCMS_BOOST_NO_AUTO_PTR
#  define CPPCMS_BOOST_NO_STRINGSTREAM
...
//
#if defined(_RWSTD_NO_TEMPLATE_ON_RETURN_TYPE) && !defined(CPPCMS_BOOST_NO_STD_LOCALE)
...
//
#if (CPPCMS_BOOST_RWSTD_VER < 0x020000) || defined(_RWSTD_NO_CLASS_PARTIAL_SPEC)
    #define CPPCMS_BOOST_NO_STD_DISTANCE
#endif
...
// OutputIterators:
//
#if CPPCMS_BOOST_RWSTD_VER < 0x020100
...
//
#if !defined(_RWSTD_LONG_LONG) && defined(CPPCMS_BOOST_HAS_LONG_LONG)
#  undef CPPCMS_BOOST_HAS_LONG_LONG
#endif
...
//
#if defined(__HP_aCC) && (CPPCMS_BOOST_RWSTD_VER == 0x02020100)
